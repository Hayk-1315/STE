      ...
      var l = {
        "grafana-scenes": {
          components: {
            ...
            "fallback-page": {
              content:
                "Se un link ti ha portato qui, potrebbe esserci un bug in questa applicazione.",
            ...
            "scene-grid-row": { "collapse-row": "Riduci riga", "expand-row": "Espandi riga" },
            ...
            "viz-panel": { title: { title: "Titolo" } },
            "viz-panel-explore-button": { explore: "Esplora" },
            "viz-panel-renderer": {
              "loading-plugin-panel":
                "Caricamento del pannello dei componenti aggiuntivi in corso...",
              "panel-plugin-has-no-panel-component":
                "Il plug-in del pannello non ha alcun componente del pannello",
            },
            "viz-panel-series-limit": {
              "content-rendering-series-single-panel-impact-performance":
                "Il rendering di troppe serie in un singolo pannello può influire sulle prestazioni e rendere più difficile la lettura dei dati.",
              "warning-message": "Mostra solo {{seriesLimit}} serie",
            },
          },
          utils: {
            "controls-label": { "tooltip-remove": "Rimuovi" },
            "loading-indicator": { "content-cancel-query": "Annulla query" },
          },
          variables: {
            "ad-hoc-combobox": {
            ...
            "ad-hoc-filter-renderer": {
              ...
              "key-select": { "placeholder-select-label": "Seleziona etichetta" },
              "label-select-label": "Seleziona etichetta",
              "title-remove-filter": "Rimuovi filtro",
              "value-select": { "placeholder-select-value": "Seleziona valore" },
            },
            "data-source-variable": { label: { default: "predefinito" } },
            "default-group-by-custom-indicator-container": {
              "aria-label-clear": "cancella",
              tooltip:
                "Applicato per impostazione predefinita in questa dashboard. Se modificato, viene trasferito ad altre dashboard.",
              "tooltip-restore-groupby-set-by-this-dashboard":
                "Ripristina il raggruppamento impostato da questa dashboard.",
            },
            "format-registry": {
              formats: {
                description: {
                  ...
                  "format-multivalued-variables-using-syntax-example":
                    "Formatta le variabili a più valori utilizzando la sintassi glob, esempio {value1,value2}",
                  ...
                  "multiple-values-are-formatted-like-variablevalue":
                    "I valori multipli sono formattati come variabile=valore",
                  "single-quoted-values": "Valori tra virgolette singole",
                  "useful-escaping-values-taking-syntax-characters":
                    "Utile per i valori di escape degli URL, tenendo conto dei caratteri di sintassi URI",
            ...
            "interval-variable": { "placeholder-select-value": "Seleziona valore" },
            "loading-options-placeholder": { "loading-options": "Caricamento opzioni in corso..." },
            "multi-value-apply-button": { apply: "Applica" },
            "no-options-placeholder": { "no-options-found": "Nessuna opzione trovata" },
            "options-error-placeholder": {
              "error-occurred-fetching-labels-click-retry":
                "Si è verificato un errore durante il recupero delle etichette. Clicca per riprovare",
            },
            "test-object-with-variable-dependency": { title: { hello: "Ciao" } },
            "test-variable": { text: { text: "Testo" } },
            "variable-value-input": { "placeholder-enter-value": "Inserisci valore" },
            "variable-value-select": { "placeholder-select-value": "Seleziona valore" },
          },
        },
      };
    },
...
//# sourceMappingURL=644.js.map?_cache=14d38f9a6e5a99fbf61f
