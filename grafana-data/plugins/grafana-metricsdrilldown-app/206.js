      ...
      var o = {
        "grafana-scenes": {
          components: {
            ...
            splitter: { "aria-label-pane-resize-widget": "Widget de redimensionamento de painel" },
            ...
            "viz-panel-renderer": {
              ...
              "panel-plugin-has-no-panel-component":
                "O plugin do painel não tem componente de painel",
            },
            "viz-panel-series-limit": {
              "content-rendering-series-single-panel-impact-performance":
                "A renderização de demasiadas séries num único painel pode afetar o desempenho e dificultar a leitura dos dados. ",
          ...
          variables: {
            ...
            "ad-hoc-filter-renderer": {
              ...
              "key-select": { "placeholder-select-label": "Selecione etiqueta" },
            ...
            "default-group-by-custom-indicator-container": {
              ...
              tooltip:
                "Aplicado por predefinição neste painel de controlo. Em caso de edição, é transferido para outros painéis de controlo.",
              "tooltip-restore-groupby-set-by-this-dashboard":
                "Restaurar grupo definido por este painel de controlo.",
            },
            "format-registry": {
              formats: {
                description: {
                  ...
                  "format-multivalued-variables-using-syntax-example":
                    "Formatar variáveis de valores múltiplos com a sintaxe glob, exemplo {value1,value2}",
                  ...
                  "multiple-values-are-formatted-like-variablevalue":
                    "Os valores múltiplos são formatados como variável=valor",
                  "single-quoted-values": "Valores entre aspas simples",
                  "useful-escaping-values-taking-syntax-characters":
                    "Útil para valores de escape de URL, tendo em conta carateres de sintaxe URI",
            ...
            "loading-options-placeholder": { "loading-options": "A carregar opções..." },
            ...
            "options-error-placeholder": {
              "error-occurred-fetching-labels-click-retry":
                "Ocorreu um erro ao obter as etiquetas. Clique para tentar novamente",
            },
            "test-object-with-variable-dependency": { title: { hello: "Olá" } },
            "test-variable": { text: { text: "Texto" } },
            "variable-value-input": { "placeholder-enter-value": "Introduza o valor" },
...
//# sourceMappingURL=206.js.map?_cache=130901d6a2dcaa8e3dfe
