      ...
      var a = {
        "grafana-scenes": {
          components: {
            ...
            "fallback-page": {
              content:
                "Wenn Sie über einen Link hierher gekommen sind, enthält diese Anwendung möglicherweise einen Fehler.",
            ...
            splitter: { "aria-label-pane-resize-widget": "Widget zur Größenänderung des Bereichs" },
            ...
            "viz-panel-series-limit": {
              "content-rendering-series-single-panel-impact-performance":
                "Das Rendern von zu vielen Reihen in einem einzigen Panel kann die Leistung beeinträchtigen und das Lesen der Daten erschweren.",
              "warning-message": "Es werden nur {{seriesLimit}} Reihen angezeigt",
            },
          },
          utils: {
            "controls-label": { "tooltip-remove": "Entfernen" },
            "loading-indicator": { "content-cancel-query": "Abfrage abbrechen" },
          },
          variables: {
            "ad-hoc-combobox": { "aria-label-edit-filter-operator": "Filteroperator bearbeiten" },
            ...
            "ad-hoc-filter-renderer": {
              ...
              "key-select": { "placeholder-select-label": "Label auswählen" },
              "label-select-label": "Label auswählen",
              "title-remove-filter": "Filter entfernen",
              "value-select": { "placeholder-select-value": "Wert auswählen" },
            },
            "data-source-variable": { label: { default: "Standard" } },
            "default-group-by-custom-indicator-container": {
              "aria-label-clear": "löschen",
              tooltip:
                "Wird in diesem Dashboard standardmäßig angewendet. Wenn es bearbeitet wird, wird es auf andere Dashboards übertragen.",
              ...
              formats: {
                description: {
                  ...
                  "useful-escaping-values-taking-syntax-characters":
                    "Nützlich für URL-Escaping-Werte, die URI-Syntaxzeichen nutzen",
            ...
            "interval-variable": { "placeholder-select-value": "Wert auswählen" },
            "loading-options-placeholder": { "loading-options": "Optionen werden geladen …" },
            "multi-value-apply-button": { apply: "Anwenden" },
            "no-options-placeholder": { "no-options-found": "Keine Optionen gefunden" },
            ...
            "variable-value-input": { "placeholder-enter-value": "Wert eingeben" },
            "variable-value-select": { "placeholder-select-value": "Wert auswählen" },
          },
        },
      };
    },
...
//# sourceMappingURL=876.js.map?_cache=1a7696652a5f03389ba7
