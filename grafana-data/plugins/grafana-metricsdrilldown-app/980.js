      ...
      var i = {
        "grafana-scenes": {
          components: {
            ...
            "fallback-page": {
              content:
                "Jika Anda diarahkan ke sini menggunakan tautan, mungkin ada bug dalam aplikasi ini.",
            ...
            "scene-grid-row": { "collapse-row": "Ciutkan baris", "expand-row": "Perbesar baris" },
            ...
            splitter: { "aria-label-pane-resize-widget": "Widget pengubah ukuran panel" },
            "time-picker": { "move-backward-tooltip": "", "move-forward-tooltip": "" },
            "viz-panel": { title: { title: "Judul" } },
            "viz-panel-explore-button": { explore: "Jelajahi" },
            "viz-panel-renderer": {
            ...
            "viz-panel-series-limit": {
              "content-rendering-series-single-panel-impact-performance":
                "Menampilkan terlalu banyak seri data dalam satu panel dapat memengaruhi kinerja dan membuat data lebih sulit dibaca.",
              "warning-message": "Menampilkan {{seriesLimit}} seri data saja",
            },
          },
          utils: {
            "controls-label": { "tooltip-remove": "Hapus" },
            "loading-indicator": { "content-cancel-query": "Batalkan kueri" },
          },
          variables: {
            "ad-hoc-combobox": { "aria-label-edit-filter-operator": "Edit operator filter" },
            ...
            "ad-hoc-filter-renderer": {
              ...
              "key-select": { "placeholder-select-label": "Pilih label" },
              "label-select-label": "Pilih label",
              "title-remove-filter": "Hapus filter",
              "value-select": { "placeholder-select-value": "Pilih nilai" },
            },
            "data-source-variable": { label: { default: "default" } },
            "default-group-by-custom-indicator-container": {
              "aria-label-clear": "hapus",
              tooltip:
                "Diterapkan secara default di dasbor ini. Jika diedit, ini akan diteruskan ke dasbor lain.",
              "tooltip-restore-groupby-set-by-this-dashboard":
                "Pulihkan 'kelompokkan berdasarkan' yang ditetapkan oleh dasbor ini.",
            },
            "format-registry": {
              formats: {
                description: {
                  ...
                  "format-date-in-different-ways":
                    "Format tanggal dengan berbagai cara yang berbeda",
                  "format-multivalued-variables-using-syntax-example":
                    "Format variabel multi-nilai menggunakan sintaks glob, contoh {value1, value2}",
                  ...
                  "multiple-values-are-formatted-like-variablevalue":
                    "Beberapa nilai diformat seperti variabel=nilai",
                  "single-quoted-values": "Nilai dalam tanda kutip tunggal",
                  "useful-escaping-values-taking-syntax-characters":
                    "Berguna untuk nilai escaping URL, memperhitungkan karakter sintaks URI",
            ...
            "interval-variable": { "placeholder-select-value": "Pilih nilai" },
            "loading-options-placeholder": { "loading-options": "Memuat opsi..." },
            "multi-value-apply-button": { apply: "Terapkan" },
            "no-options-placeholder": { "no-options-found": "Opsi tidak ditemukan" },
            "options-error-placeholder": {
              "error-occurred-fetching-labels-click-retry":
                "Terjadi kesalahan saat mengambil label. Klik untuk mencoba lagi",
            },
            "test-object-with-variable-dependency": { title: { hello: "Halo" } },
            "test-variable": { text: { text: "Teks" } },
            "variable-value-input": { "placeholder-enter-value": "Masukkan nilai" },
            "variable-value-select": { "placeholder-select-value": "Pilih nilai" },
          },
        },
      };
    },
...
//# sourceMappingURL=980.js.map?_cache=655996be379e3e595023
