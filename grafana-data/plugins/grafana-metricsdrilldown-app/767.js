      ...
      var t = {
        "grafana-scenes": {
          components: {
            ...
            "scene-grid-row": { "collapse-row": "Collapse row", "expand-row": "Expand row" },
          ...
          utils: {
            "controls-label": { "tooltip-remove": "Remove" },
            "loading-indicator": { "content-cancel-query": "Cancel query" },
          },
          variables: {
            "ad-hoc-combobox": { "aria-label-edit-filter-operator": "Edit filter operator" },
            ...
            "ad-hoc-filter-renderer": {
              ...
              "key-select": { "placeholder-select-label": "Select label" },
              "label-select-label": "Select label",
              "title-remove-filter": "Remove filter",
              "value-select": { "placeholder-select-value": "Select value" },
            },
            ...
            "interval-variable": { "placeholder-select-value": "Select value" },
            "loading-options-placeholder": { "loading-options": "Loading options..." },
            "multi-value-apply-button": { apply: "Apply" },
            "no-options-placeholder": { "no-options-found": "No options found" },
            "options-error-placeholder": {
              "error-occurred-fetching-labels-click-retry":
                "An error has occurred fetching labels. Click to retry",
            },
            "test-object-with-variable-dependency": { title: { hello: "Hello" } },
            "test-variable": { text: { text: "Text" } },
            "variable-value-input": { "placeholder-enter-value": "Enter value" },
            "variable-value-select": { "placeholder-select-value": "Select value" },
          },
        },
      };
    },
...
//# sourceMappingURL=767.js.map?_cache=b4f9d973b92b7eab01ca
