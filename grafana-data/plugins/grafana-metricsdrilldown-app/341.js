      ...
      var t = {
        "grafana-scenes": {
          components: {
            ...
            "scene-grid-row": { "collapse-row": "收闔列", "expand-row": "展開列" },
            ...
            splitter: { "aria-label-pane-resize-widget": "窗格調整大小小工具" },
            "time-picker": { "move-backward-tooltip": "", "move-forward-tooltip": "" },
            "viz-panel": { title: { title: "標題" } },
            ...
            "viz-panel-series-limit": {
              "content-rendering-series-single-panel-impact-performance":
                "在單個面板中呈現太多序列可能會影響效能，並使資料更難讀取。",
              "warning-message": "僅顯示 {{seriesLimit}} 個序列",
            },
          },
          utils: {
            "controls-label": { "tooltip-remove": "移除" },
            "loading-indicator": { "content-cancel-query": "取消查詢" },
          },
          variables: {
            "ad-hoc-combobox": { "aria-label-edit-filter-operator": "編輯篩選條件運算子" },
            ...
            "ad-hoc-filter-renderer": {
              ...
              "key-select": { "placeholder-select-label": "選擇標籤" },
              "label-select-label": "選擇標籤",
              "title-remove-filter": "移除篩選條件",
              "value-select": { "placeholder-select-value": "選擇值" },
            },
            "data-source-variable": { label: { default: "預設值" } },
              ...
              formats: {
                description: {
                  ...
                  "format-multivalued-variables-using-syntax-example":
                    "使用 glob 語法格式化多值變數，例如 {value1,value2}",
            ...
            "interval-variable": { "placeholder-select-value": "選擇值" },
            "loading-options-placeholder": { "loading-options": "正在載入選項…" },
            "multi-value-apply-button": { apply: "套用" },
            "no-options-placeholder": { "no-options-found": "未找到選項" },
            ...
            "test-variable": { text: { text: "文字" } },
            "variable-value-input": { "placeholder-enter-value": "輸入值" },
            "variable-value-select": { "placeholder-select-value": "選擇值" },
          },
        },
      };
    },
...
//# sourceMappingURL=341.js.map?_cache=8f9cffe8b5fc06dedcdc
