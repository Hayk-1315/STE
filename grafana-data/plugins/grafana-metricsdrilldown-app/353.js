      ...
      var t = {
        "grafana-scenes": {
          components: {
            ...
            "fallback-page": {
              content:
                "링크를 사용하여 여기로 이동한 경우 이 애플리케이션에 버그가 있을 수 있습니다.",
            ...
            "scene-grid-row": { "collapse-row": "행 접기", "expand-row": "행 펼치기" },
            ...
            splitter: { "aria-label-pane-resize-widget": "창 크기 조정 위젯" },
            "time-picker": { "move-backward-tooltip": "", "move-forward-tooltip": "" },
            "viz-panel": { title: { title: "제목" } },
            "viz-panel-explore-button": { explore: "탐색" },
            "viz-panel-renderer": {
            ...
            "viz-panel-series-limit": {
              "content-rendering-series-single-panel-impact-performance":
                "하나의 패널에 너무 많은 시리즈를 렌더링하면 성능에 영향을 주고 데이터가 읽기 어려워질 수 있습니다. ",
              "warning-message": "{{seriesLimit}}개 시계열만 표시 중",
            },
          },
          utils: {
            "controls-label": { "tooltip-remove": "제거" },
            "loading-indicator": { "content-cancel-query": "쿼리 취소" },
          },
          variables: {
            "ad-hoc-combobox": { "aria-label-edit-filter-operator": "필터 연산자 편집" },
            ...
            "ad-hoc-filter-renderer": {
              ...
              "key-select": { "placeholder-select-label": "레이블 선택" },
              "label-select-label": "레이블 선택",
              "title-remove-filter": "필터 제거",
              "value-select": { "placeholder-select-value": "값 선택" },
            },
            "data-source-variable": { label: { default: "기본값" } },
            "default-group-by-custom-indicator-container": {
              "aria-label-clear": "지우기",
              tooltip:
                "이 대시보드에서 기본적으로 적용됩니다. 편집하면 다른 대시보드로 이전됩니다.",
              "tooltip-restore-groupby-set-by-this-dashboard":
                "이 대시보드에서 설정한 '그룹별'을 복원합니다.",
            },
            "format-registry": {
              formats: {
                description: {
                  ...
                  "format-multivalued-variables-using-syntax-example":
                    "glob 구문을 사용하여 다중 값 변수 형식 지정, 예: {value1,value2}",
            ...
            "interval-variable": { "placeholder-select-value": "값 선택" },
            "loading-options-placeholder": { "loading-options": "옵션 로딩 중..." },
            "multi-value-apply-button": { apply: "적용" },
            "no-options-placeholder": { "no-options-found": "찾은 옵션 없음" },
            "options-error-placeholder": {
              "error-occurred-fetching-labels-click-retry":
                "라벨을 가져오는 동안 오류가 발생했습니다. 클릭하여 다시 시도",
            },
            "test-object-with-variable-dependency": { title: { hello: "안녕하세요" } },
            "test-variable": { text: { text: "텍스트" } },
            "variable-value-input": { "placeholder-enter-value": "값 입력" },
            "variable-value-select": { "placeholder-select-value": "값 선택" },
          },
        },
      };
    },
...
//# sourceMappingURL=353.js.map?_cache=00ac2f1a6a55baf37ac5
