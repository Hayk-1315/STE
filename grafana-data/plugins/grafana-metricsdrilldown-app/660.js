      ...
      var t = {
        "grafana-scenes": {
          components: {
            ...
            "scene-grid-row": { "collapse-row": "折叠行", "expand-row": "展开行" },
            ...
            splitter: { "aria-label-pane-resize-widget": "窗格大小调整小部件" },
            "time-picker": { "move-backward-tooltip": "", "move-forward-tooltip": "" },
            "viz-panel": { title: { title: "标题" } },
            "viz-panel-explore-button": { explore: "探索" },
            "viz-panel-renderer": {
            ...
            "viz-panel-series-limit": {
              "content-rendering-series-single-panel-impact-performance":
                "在单个面板中呈现太多系列可能会影响性能，并使数据难以阅读。",
              "warning-message": "仅显示 {{seriesLimit}} 系列",
            },
          },
          utils: {
            "controls-label": { "tooltip-remove": "移除" },
            "loading-indicator": { "content-cancel-query": "取消查询" },
          },
          variables: {
            "ad-hoc-combobox": { "aria-label-edit-filter-operator": "编辑筛选器运算符" },
            ...
            "ad-hoc-filter-renderer": {
              ...
              "key-select": { "placeholder-select-label": "选择标签" },
              "label-select-label": "选择标签",
              "title-remove-filter": "移除筛选条件",
              "value-select": { "placeholder-select-value": "选择值" },
            },
            "data-source-variable": { label: { default: "默认" } },
              ...
              formats: {
                description: {
                  ...
                  "format-multivalued-variables-using-syntax-example":
                    "使用 glob 语法格式化多值变量，例如 {value1,value2}",
            ...
            "interval-variable": { "placeholder-select-value": "选择值" },
            "loading-options-placeholder": { "loading-options": "正在加载选项…" },
            "multi-value-apply-button": { apply: "应用" },
            "no-options-placeholder": { "no-options-found": "未找到选项" },
            "options-error-placeholder": {
              "error-occurred-fetching-labels-click-retry": "获取标签时发生错误。单击重试",
            },
            "test-object-with-variable-dependency": { title: { hello: "您好" } },
            "test-variable": { text: { text: "文本" } },
            "variable-value-input": { "placeholder-enter-value": "输入数值" },
            "variable-value-select": { "placeholder-select-value": "选择值" },
          },
        },
      };
    },
...
//# sourceMappingURL=660.js.map?_cache=b143f478b19fd3cf5886
