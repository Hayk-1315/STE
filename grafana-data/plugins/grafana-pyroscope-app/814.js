      ...
      e.exports = (function () {
        ...
        : function (e, o) {
            for (
              ...
              if (t) {
                a = t(i);
                for (var f = 0; f < a.length; f++) n.call(i, a[f]) && (c[a[f]] = i[a[f]]);
              }
            }
            return c;
          };
      ...
      function i(e, a) {
        ...
        if (e && a && "object" == typeof e && "object" == typeof a) {
          ...
          if (Array.isArray(e)) {
            ...
            for (u = c; 0 != u--; ) if (!i(e[u], a[u])) return !1;
            return !0;
          }
          if (r && e instanceof Map && a instanceof Map) {
            if (e.size !== a.size) return !1;
            for (f = e.entries(); !(u = f.next()).done; ) if (!a.has(u.value[0])) return !1;
          ...
          if (o && ArrayBuffer.isView(e) && ArrayBuffer.isView(a)) {
            if ((c = e.length) != a.length) return !1;
            for (u = c; 0 != u--; ) if (e[u] !== a[u]) return !1;
            return !0;
          }
          ...
          for (u = c; 0 != u--; ) if (!Object.prototype.hasOwnProperty.call(a, s[u])) return !1;
      ...
      var n,
        ...
        oe = function (e, t) {
          var r = e.baseTag,
            ...
            l = e.title,
            p = e.titleAttributes;
          (ce(v.BODY, n), ce(v.HTML, o), ae(l, p));
          var d = {
              baseTag: ue(v.BASE, r),
              linkTags: ue(v.LINK, i),
              metaTags: ue(v.META, a),
              noscriptTags: ue(v.NOSCRIPT, c),
              scriptTags: ue(v.SCRIPT, s),
              styleTags: ue(v.STYLE, f),
            },
            y = {},
            h = {};
        ...
        ce = function (e, t) {
          ...
          if (r) {
            ...
            o.length === i.length
              ? r.removeAttribute(H)
              : r.getAttribute(H) !== a.join(",") && r.setAttribute(H, a.join(","));
          }
        },
        ue = function (e, t) {
          var r = document.head || document.querySelector(v.HEAD),
            n = r.querySelectorAll(e + "[" + H + "]"),
        ...
        pe = function (e) {
          ...
          return {
            base: le(v.BASE, t, n),
            bodyAttributes: le(m, r, n),
            htmlAttributes: le(T, o, n),
            link: le(v.LINK, i, n),
            meta: le(v.META, a, n),
            noscript: le(v.NOSCRIPT, c, n),
            script: le(v.SCRIPT, u, n),
            style: le(v.STYLE, s, n),
            title: le(v.TITLE, { title: l, titleAttributes: p }, n),
          };
        },
        de = f()(
          function (e) {
            return {
              ...
              encode: Q(e, _),
              htmlAttributes: $(T, e),
              linkTags: J(v.LINK, [k, A], e),
              metaTags: J(v.META, [j, w, C, P, E], e),
              noscriptTags: J(v.NOSCRIPT, [S], e),
              onChangeClientState: W(e),
              scriptTags: J(v.SCRIPT, [L, S], e),
            ...
            (function (e) {
              ...
              return (
                ...
                (t.prototype.mapObjectTypeChildren = function (e) {
                  ...
                  switch (n.type) {
                    case v.TITLE:
                      return U({}, o, (((t = {})[n.type] = a), (t.titleAttributes = U({}, i)), t));
                    case v.BODY:
                ...
                (t.prototype.render = function () {
                  var e = this.props,
                    ...
                    r = z(e, ["children"]),
                    n = U({}, r);
                  return (t && (n = this.mapChildrenToProps(t, n)), y().createElement(o, n));
                }),
                F(t, null, [
                  {
                    key: "canUseDOM",
...
//# sourceMappingURL=814.js.map?_cache=c2d7b8b2edef28301efd
