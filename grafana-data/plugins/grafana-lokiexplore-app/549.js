      ...
      var t = {
        "grafana-scenes": {
          components: {
            ...
            "fallback-page": {
              content:
                "Pokud jste se sem dostali pomocí odkazu, může se jednat o chybu v této aplikaci.",
            ...
            "scene-grid-row": { "collapse-row": "Sbalit řádek", "expand-row": "Rozbalit řádek" },
            ...
            splitter: { "aria-label-pane-resize-widget": "Widget pro změnu velikosti panelu" },
            "time-picker": { "move-backward-tooltip": "", "move-forward-tooltip": "" },
            "viz-panel": { title: { title: "Název" } },
            "viz-panel-explore-button": { explore: "Prozkoumat" },
            "viz-panel-renderer": {
            ...
            "viz-panel-series-limit": {
              "content-rendering-series-single-panel-impact-performance":
                "Renderování příliš mnoha řad v rámci jednoho panelu může ovlivnit výkon a zhoršit čitelnost dat.",
              "warning-message": "Zobrazují se pouze {{seriesLimit}} série/sérií",
            },
          },
          utils: {
            "controls-label": { "tooltip-remove": "Odebrat" },
            "loading-indicator": { "content-cancel-query": "Zrušit dotaz" },
          },
          variables: {
            "ad-hoc-combobox": { "aria-label-edit-filter-operator": "Upravit operátor filtru" },
            ...
            "ad-hoc-filter-renderer": {
              ...
              "key-select": { "placeholder-select-label": "Vybrat štítek" },
              "label-select-label": "Vybrat štítek",
              "title-remove-filter": "Odebrat filtr",
              "value-select": { "placeholder-select-value": "Vybrat hodnotu" },
            },
            "data-source-variable": { label: { default: "výchozí" } },
            "default-group-by-custom-indicator-container": {
              "aria-label-clear": "vymazat",
              tooltip:
                "Použito ve výchozím nastavení na této nástěnce. Pokud je upraveno, přenese se na jiné nástěnky.",
              "tooltip-restore-groupby-set-by-this-dashboard":
                "Obnovit skupinu nastavenou touto nástěnkou.",
            },
            "format-registry": {
              formats: {
                description: {
                  ...
                  "format-multivalued-variables-using-syntax-example":
                    "Formátovat vícehodnotové proměnné pomocí globální syntaxe, například {value1,value2}",
                  ...
                  "multiple-values-are-formatted-like-variablevalue":
                    "Více hodnot je formátováno jako proměnná=hodnota",
                  "single-quoted-values": "Hodnoty v jednoduchých uvozovkách",
                  "useful-escaping-values-taking-syntax-characters":
                    "Užitečné pro hodnoty HTML escapování, přičemž se bere v úvahu syntaxe URL",
            ...
            "interval-variable": { "placeholder-select-value": "Vybrat hodnotu" },
            "loading-options-placeholder": { "loading-options": "Načítání možností…" },
            "multi-value-apply-button": { apply: "Použít" },
            "no-options-placeholder": { "no-options-found": "Nebyly nalezeny žádné možnosti" },
            "options-error-placeholder": {
              "error-occurred-fetching-labels-click-retry":
                "Při načítání štítků došlo k chybě. Klikněte pro opakování",
            },
            "test-object-with-variable-dependency": { title: { hello: "Dobrý den" } },
            "test-variable": { text: { text: "Text" } },
            "variable-value-input": { "placeholder-enter-value": "Zadat hodnotu" },
            "variable-value-select": { "placeholder-select-value": "Vybrat hodnotu" },
          },
        },
      };
    },
...
//# sourceMappingURL=549.js.map?_cache=15cbc5fe0b2aa7664493
