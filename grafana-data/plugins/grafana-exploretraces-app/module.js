...
define([
  ...
  (() => {
    ...
    var h,
      ...
      c = {
        ...
        61829: (m, e, t) => {
          ...
          var n = (function (m) {
            return ((m.Explore = "explore"), (m.Home = "home"), m);
          })({});
          const o = `${`/a/${r.id}`}/explore`,
            a = "grafana.drilldown.traces.datasource",
            l = "grafana.drilldown.traces.homepage.filters",
            p = "grafana.drilldown.traces.bookmarks",
            O = "repeat(auto-fit, minmax(400px, 1fr))",
            h = "No data for selected query",
            u = "Please try removing some filters or changing your query.",
            c = " && ",
            f = "ds",
            S = "${ds}",
            d = "primarySignal",
            v = "filters",
            x = "${primarySignal} && ${filters}",
            g = "homeFilter",
            Q = "groupBy",
            w = "spanListColumns",
            R = "metric",
            z = "latencyThreshold",
            b = "${latencyThreshold}",
            k = "partialLatencyThreshold",
            P = "${partialLatencyThreshold}",
            y = "durationPercentiles",
            T = "${durationPercentiles:csv}",
            $ = { uid: S },
            X = "actionView",
            U = "primarySignal",
            Y = "selection",
          ...
          class V extends s.BusEventWithPayload {}
          i(V, "type", "timeseries-data-received");
          class E extends s.BusEventWithPayload {}
          i(E, "type", "trace-opened");
          const I = [{ id: "filterByRefId", options: { exclude: "streaming-progress" } }];
        },
        62533: (m) => {
          m.exports = JSON.parse('{"id":"grafana-exploretraces-app"}');
        },
        79089: (m) => {
          m.exports = i;
        },
    ...
    function S(m) {
      ...
      var t = (f[m] = { id: m, loaded: !1, exports: {} });
      return (c[m].call(t.exports, t, t.exports, S), (t.loaded = !0), t.exports);
    }
    ((S.m = c),
      (S.n = (m) => {
        var e = m && m.__esModule ? () => m.default : () => m;
        return (S.d(e, { a: e }), e);
      }),
      (S.d = (m, e) => {
        for (var t in e)
          S.o(e, t) && !S.o(m, t) && Object.defineProperty(m, t, { enumerable: !0, get: e[t] });
      }),
      (S.f = {}),
      (S.e = (m) => Promise.all(Object.keys(S.f).reduce((e, t) => (S.f[t](m, e), e), []))),
      (S.u = (m) =>
        m +
        ".js?_cache=" +
        {
          156: "e167fe345e30e9bf6f22",
          200: "aab48b7cfc185576653f",
          202: "d57decc07c3263eef3bb",
          535: "57603cf48bcb03240c4a",
          722: "acdc8abd059829a87569",
          766: "82ff3d37096ced3515d5",
          782: "dbd72787524d42c68319",
          812: "ccee62b1efb9b2ee9d6e",
        }[m]),
      (S.g = (function () {
      ...
      (S.o = (m, e) => Object.prototype.hasOwnProperty.call(m, e)),
      (h = {}),
      (u = "grafana-exploretraces-app:"),
      (S.l = (m, e, t, s) => {
        if (h[m]) h[m].push(e);
        else {
          var r, i;
          if (void 0 !== t)
            for (var n = document.getElementsByTagName("script"), o = 0; o < n.length; o++) {
              var a = n[o];
              if (a.getAttribute("src") == m || a.getAttribute("data-webpack") == u + t) {
                r = a;
                break;
              }
            }
          ...
          var l = (e, t) => {
            ...
            p = setTimeout(l.bind(null, void 0, { type: "timeout", target: r }), 12e4);
      ...
      (S.nmd = (m) => ((m.paths = []), m.children || (m.children = []), m)),
      (S.p = "public/plugins/grafana-exploretraces-app/"),
      (S.sriHashes = {
        156: "sha256-ptS5GQbqDM67fAIlq9NPE9+tVh0y4Ebv7OhQRwAqECs=",
        200: "sha256-p2vLwNbuxA05Uo4zoTWsGajuXm3GJZWh3zjoVJM0+yc=",
        202: "sha256-nIs/r7ANvSyQ7lFV46Qh0B7cz8XfyAytAooSPxxEtKU=",
        535: "sha256-8LyJ4Vjcv05S4wE/PkRNob2BWsFZsDfbSN3bXoda3kY=",
        722: "sha256-lWaHmMpyMyMBvp+H/JYNWINaDREQvB2n4jwFJ+sKvZk=",
        766: "sha256-RZxsn/DNb1L/Vq+E+SghncnoFS2mfJf5IXnpr97WlXM=",
        782: "sha256-h/Ga10rNHilMThR8agFkjmc8jg5aguHyzkBRvgQzInY=",
        812: "sha256-J4GtlDMmOQx0PDsr+gzUf/TN1idoEVZxdGvJmc5QZug=",
      }),
      (() => {
        var m = { 231: 0 };
        S.f.j = (e, t) => {
          var s = S.o(m, e) ? m[e] : void 0;
          if (0 !== s)
            if (s) t.push(s[2]);
            else {
              var r = new Promise((t, r) => (s = m[e] = [t, r]));
              t.push((s[2] = r));
              var i = S.p + S.u(e),
                n = new Error();
              S.l(
                i,
                (t) => {
                  if (S.o(m, e) && (0 !== (s = m[e]) && (m[e] = void 0), s)) {
        ...
        var e = (e, t) => {
            var s,
              ...
              a = 0;
            if (i.some((e) => 0 !== m[e])) {
              for (s in n) S.o(n, s) && (S.m[s] = n[s]);
              if (o) o(S);
            }
            for (e && e(t); a < i.length; a++)
              ((r = i[a]), S.o(m, r) && m[r] && m[r][0](), (m[r] = 0));
          },
          t = (self.webpackChunkgrafana_exploretraces_app =
            self.webpackChunkgrafana_exploretraces_app || []);
        (t.forEach(e.bind(null, 0)), (t.push = e.bind(null, t.push.bind(t))));
      })(),
      (S.nc = void 0));
    var d = {};
    (S.r(d), S.d(d, { plugin: () => Bm }));
    var v = S(41308),
      x = S.n(v);
    S.p =
      x() && x().uri
        ? x().uri.slice(0, x().uri.lastIndexOf("/") + 1)
        : "public/plugins/grafana-exploretraces-app/";
    var g = S(85959),
      Q = S.n(g),
      w = S(87781),
      R = S(82007);
    const z = (0, g.lazy)(() => S.e(812).then(S.bind(S, 15812))),
      b = (0, g.lazy)(() => Promise.all([S.e(200), S.e(782), S.e(722)]).then(S.bind(S, 28722)));
    var k = S(61829);
    const P = 1024;
    let y = 0;
    class T {
      constructor(m, e) {
        ((this.from = m), (this.to = e));
      }
    }
    class $ {
      constructor(m = {}) {
        ((this.id = y++),
          (this.perNode = !!m.perNode),
          (this.deserialize =
            m.deserialize ||
            (() => {
              throw new Error("This node type doesn't define a deserialize function");
            })),
          (this.combine = m.combine || null));
      }
      add(m) {
        if (this.perNode) throw new RangeError("Can't add per-node props to node types");
        return (
          "function" != typeof m && (m = Y.match(m)),
          (e) => {
            let t = m(e);
    ...
    (($.closedBy = new $({ deserialize: (m) => m.split(" ") })),
      ($.openedBy = new $({ deserialize: (m) => m.split(" ") })),
      ($.group = new $({ deserialize: (m) => m.split(" ") })),
      ($.isolate = new $({
        deserialize: (m) => {
          if (m && "rtl" != m && "ltr" != m && "auto" != m)
            throw new RangeError("Invalid value for isolate: " + m);
          return m || "auto";
        },
      })),
    ...
    class X {
      constructor(m, e, t, s = !1) {
        ((this.tree = m), (this.overlay = e), (this.parser = t), (this.bracketed = s));
      }
      static get(m) {
        return m && m.props && m.props[$.mounted.id];
      }
    }
    const U = Object.create(null);
    class Y {
      constructor(m, e, t, s = 0) {
        ((this.name = m), (this.props = e), (this.id = t), (this.flags = s));
      }
      static define(m) {
        let e = m.props && m.props.length ? Object.create(null) : U,
          t = (m.top ? 1 : 0) | (m.skipped ? 2 : 0) | (m.error ? 4 : 0) | (null == m.name ? 8 : 0),
          s = new Y(m.name || "", e, m.id, t);
        if (m.props)
          for (let t of m.props)
            if ((Array.isArray(t) || (t = t(s)), t)) {
              if (t[0].perNode) throw new RangeError("Can't store a per-node prop on a node type");
              e[t[0].id] = t[1];
            }
        return s;
      }
      prop(m) {
        return this.props[m.id];
      }
      get isTop() {
      ...
      is(m) {
        if ("string" == typeof m) {
          if (this.name == m) return !0;
          let e = this.prop($.group);
          return !!e && e.indexOf(m) > -1;
        }
        return this.id == m;
      }
      static match(m) {
        let e = Object.create(null);
        for (let t in m) for (let s of t.split(" ")) e[s] = m[t];
        return (m) => {
          for (let t = m.prop($.group), s = -1; s < (t ? t.length : 0); s++) {
            let r = e[s < 0 ? m.name : t[s]];
            if (r) return r;
          }
        };
      }
    }
    Y.none = new Y("", Object.create(null), 0, 8);
    class C {
      constructor(m) {
        this.types = m;
      ...
      extend(...m) {
        ...
        for (let t of this.types) {
          ...
          for (let e of m) {
            let m = e(t);
            if (m) {
              s || (s = Object.assign({}, t.props));
              let e = m[1],
                r = m[0];
              (r.combine && r.id in s && (e = r.combine(s[r.id], e)), (s[r.id] = e));
            }
          }
          e.push(s ? new Y(t.name, s, t.id, t.flags) : t);
        }
        return new C(e);
      }
    }
    ...
    var Z;
    !(function (m) {
      ((m[(m.ExcludeBuffers = 1)] = "ExcludeBuffers"),
        (m[(m.IncludeAnonymous = 2)] = "IncludeAnonymous"),
        (m[(m.IgnoreMounts = 4)] = "IgnoreMounts"),
        (m[(m.IgnoreOverlays = 8)] = "IgnoreOverlays"),
        (m[(m.EnterBracketed = 16)] = "EnterBracketed"));
    })(Z || (Z = {}));
    class _ {
      constructor(m, e, t, s, r) {
        if (
          ((this.type = m),
          (this.children = e),
          (this.positions = t),
          ...
          for (let [m, e] of r) this.props["number" == typeof m ? m : m.id] = e;
        }
      }
      toString() {
        let m = X.get(this);
        if (m && !m.overlay) return m.tree.toString();
        let e = "";
      ...
      cursor(m = 0) {
        return new F(this.topNode, m);
      }
      cursorAt(m, e = 0, t = 0) {
        let s = W.get(this) || this.topNode,
          r = new F(s);
        return (r.moveTo(m, e), W.set(this, r._tree), r);
      }
      get topNode() {
        return new E(this, 0, 0, null);
      }
      resolve(m, e = 0) {
        let t = D(W.get(this) || this.topNode, m, e, !1);
        return (W.set(this, t), t);
      }
      resolveInner(m, e = 0) {
        let t = D(j.get(this) || this.topNode, m, e, !0);
        return (j.set(this, t), t);
      }
      resolveStack(m, e = 0) {
        return (function (m, e, t) {
          let s = m.resolveInner(e, t),
            r = null;
          for (let m = s instanceof E ? s : s.context.parent; m; m = m.parent)
            if (m.index < 0) {
              let i = m.parent;
              ((r || (r = [s])).push(i.resolve(e, t)), (m = i));
            } else {
              let i = X.get(m.tree);
              if (
                i &&
                i.overlay &&
                i.overlay[0].from <= e &&
                i.overlay[i.overlay.length - 1].to >= e
              ) {
                let n = new E(i.tree, i.overlay[0].from + m.from, -1, m);
                (r || (r = [s])).push(D(n, e, t, !1));
              }
            }
          return r ? M(r) : s;
        })(this, m, e);
      ...
      iterate(m) {
        let { enter: e, leave: t, from: s = 0, to: r = this.length } = m,
          i = m.mode || 0,
          n = (i & Z.IncludeAnonymous) > 0;
        for (let m = this.cursor(i | Z.IncludeAnonymous); ; ) {
          let i = !1;
          if (m.from <= r && m.to >= s && ((!n && m.type.isAnonymous) || !1 !== e(m))) {
            if (m.firstChild()) continue;
            i = !0;
          }
          for (; i && t && (n || !m.type.isAnonymous) && t(m), !m.nextSibling(); ) {
            if (!m.parent()) return;
            i = !0;
          }
        }
      ...
      prop(m) {
        return m.perNode ? (this.props ? this.props[m.id] : void 0) : this.type.prop(m);
      }
      get propValues() {
        let m = [];
        if (this.props) for (let e in this.props) m.push([+e, this.props[e]]);
        return m;
      }
      balance(m = {}) {
        return this.children.length <= 8
          ...
          : em(
              ...
              0,
              this.length,
              (m, e, t) => new _(this.type, m, e, t, this.propValues),
              m.makeTree || ((m, e, t) => new _(Y.none, m, e, t)),
            );
      }
      static build(m) {
        return (function (m) {
          ...
          let {
              ...
              maxBufferLength: r = P,
              reused: i = [],
              minRepeatType: n = s.types.length,
            } = m,
            o = Array.isArray(t) ? new A(t, t.length) : t,
            a = s.types,
            l = 0,
            p = 0;
          function O(m, e, t, v, x, g) {
            let { id: Q, start: w, end: R, size: z } = o,
              b = p,
              k = l;
            if (z < 0) {
              if ((o.next(), -1 == z)) {
                let e = i[Q];
                return (t.push(e), void v.push(w - m));
              }
              if (-3 == z) return void (l = Q);
              if (-4 == z) return void (p = Q);
            ...
            let P,
              ...
              T = a[Q],
              $ = w - m;
            if (R - w <= r && (y = S(o.pos - e, x))) {
              let e = new Uint16Array(y.size - y.skip),
                t = o.pos - y.size,
                r = e.length;
              for (; o.pos > t; ) r = d(y.start, e, r);
              ((P = new q(e, R - y.start, s)), ($ = y.start - m));
            } else {
              let m = o.pos - z;
              o.next();
              let e = [],
              ...
              for (; o.pos > m; )
                s >= 0 && o.id == s && o.size >= 0
                  ? (o.end <= a - r &&
                      (c(e, t, w, i, o.end, a, s, b, k), (i = e.length), (a = o.end)),
                    o.next())
                  : g > 2500
                    ? h(w, m, e, t)
                    : O(w, m, e, t, s, g + 1);
              if (
                (s >= 0 && i > 0 && i < e.length && c(e, t, w, i, w, a, s, b, k),
                e.reverse(),
                t.reverse(),
                s > -1 && i > 0)
              ) {
                let m = u(T, k);
                P = em(T, e, t, 0, e.length, 0, R - w, m, m);
              } else P = f(T, e, t, R - w, b - R, k);
            }
            (t.push(P), v.push($));
          }
          function h(m, e, t, i) {
            let n = [],
              ...
              l = -1;
            for (; o.pos > e; ) {
              let { id: m, start: e, end: t, size: s } = o;
              if (s > 4) o.next();
              else {
                if (l > -1 && e < l) break;
                (l < 0 && (l = t - r), n.push(m, e, t), a++, o.next());
              }
            }
            if (a) {
              let e = new Uint16Array(4 * a),
                r = n[n.length - 2];
              for (let m = n.length - 3, t = 0; m >= 0; m -= 3)
                ((e[t++] = n[m]), (e[t++] = n[m + 1] - r), (e[t++] = n[m + 2] - r), (e[t++] = t));
              (t.push(new q(e, n[2] - r, s)), i.push(r - m));
            }
          }
          function u(m, e) {
            return (t, s, r) => {
              let i,
                ...
                o = 0,
                a = t.length - 1;
              if (a >= 0 && (i = t[a]) instanceof _) {
                if (!a && i.type == m && i.length == r) return i;
                (n = i.prop($.lookAhead)) && (o = s[a] + i.length + n);
              }
              return f(m, t, s, r, o, e);
            };
          }
          function c(m, e, t, r, i, n, o, a, l) {
            let p = [],
              O = [];
            for (; m.length > r; ) (p.push(m.pop()), O.push(e.pop() + t - i));
            (m.push(f(s.types[o], p, O, n - i, a - n, l)), e.push(i - t));
          }
          function f(m, e, t, s, r, i, n) {
            if (i) {
              let m = [$.contextHash, i];
              n = n ? [m].concat(n) : [m];
            }
          ...
          function S(m, e) {
            let t = o.fork(),
              ...
              a = 0,
              l = t.end - r,
              p = { size: 0, start: 0, skip: 0 };
            m: for (let r = t.pos - m; t.pos > r; ) {
              let m = t.size;
              if (t.id == e && m >= 0) {
                ((p.size = s), (p.start = i), (p.skip = a), (a += 4), (s += 4), t.next());
                continue;
              }
              let o = t.pos - m;
              if (m < 0 || o < r || t.start < l) break;
              let O = t.id >= n ? 4 : 0,
                h = t.start;
              for (t.next(); t.pos > o; ) {
                if (t.size < 0) {
                  if (-3 != t.size && -4 != t.size) break m;
                  O += 4;
                } else t.id >= n && (O += 4);
                t.next();
              }
            ...
            return (
              (e < 0 || s == m) && ((p.size = s), (p.start = i), (p.skip = a)),
              p.size > 4 ? p : void 0
            );
          }
          function d(m, e, t) {
            let { id: s, start: r, end: i, size: a } = o;
            if ((o.next(), a >= 0 && s < n)) {
              let n = t;
              if (a > 4) {
                let s = o.pos - (a - 4);
                for (; o.pos > s; ) t = d(m, e, t);
              }
              ((e[--t] = n), (e[--t] = i - m), (e[--t] = r - m), (e[--t] = s));
            } else -3 == a ? (l = s) : -4 == a && (p = s);
            return t;
          }
          let v = [],
            x = [];
          for (; o.pos > 0; ) O(m.start || 0, m.bufferStart || 0, v, x, -1, 0);
          let g = null !== (e = m.length) && void 0 !== e ? e : v.length ? x[0] + v[0].length : 0;
          return new _(a[m.topID], v.reverse(), x.reverse(), g);
        })(m);
      }
    }
    _.empty = new _(Y.none, [], [], 0);
    class A {
      constructor(m, e) {
        ((this.buffer = m), (this.index = e));
      }
      get id() {
    ...
    class q {
      constructor(m, e, t) {
        ((this.buffer = m), (this.length = e), (this.set = t));
      }
      get type() {
        return Y.none;
      }
      toString() {
        ...
        for (let e = 0; e < this.buffer.length; )
          (m.push(this.childString(e)), (e = this.buffer[e + 3]));
        return m.join(",");
      }
      childString(m) {
        let e = this.buffer[m],
          ...
          s = this.set.types[e],
          r = s.name;
        if ((/\W/.test(r) && !s.isError && (r = JSON.stringify(r)), t == (m += 4))) return r;
        let i = [];
        for (; m < t; ) (i.push(this.childString(m)), (m = this.buffer[m + 3]));
        return r + "(" + i.join(",") + ")";
      }
      findChild(m, e, t, s, r) {
        let { buffer: i } = this,
          n = -1;
        for (let o = m; o != e && !(N(r, s, i[o + 1], i[o + 2]) && ((n = o), t > 0)); o = i[o + 3]);
        return n;
      }
      slice(m, e, t) {
        let s = this.buffer,
          r = new Uint16Array(e - m),
          i = 0;
        for (let n = m, o = 0; n < e; ) {
          ((r[o++] = s[n++]), (r[o++] = s[n++] - t));
          let e = (r[o++] = s[n++] - t);
          ((r[o++] = s[n++] - m), (i = Math.max(i, e)));
        }
    ...
    function D(m, e, t, s) {
      for (
        var r;
        m.from == m.to || (t < 1 ? m.from >= e : m.from > e) || (t > -1 ? m.to <= e : m.to < e);

      ) {
        let e = !s && m instanceof E && m.index < 0 ? null : m.parent;
        if (!e) return m;
        m = e;
      }
      let i = s ? 0 : Z.IgnoreOverlays;
      if (s)
        for (let s = m, n = s.parent; n; s = n, n = s.parent)
          s instanceof E &&
            s.index < 0 &&
            (null === (r = n.enter(e, t, i)) || void 0 === r ? void 0 : r.from) != s.from &&
            (m = n);
      for (;;) {
        let s = m.enter(e, t, i);
        if (!s) return m;
    ...
    class V {
      ...
      getChild(m, e = null, t = null) {
        let s = I(this, m, e, t);
        return s.length ? s[0] : null;
      }
      getChildren(m, e = null, t = null) {
        return I(this, m, e, t);
      }
      resolve(m, e = 0) {
        return D(this, m, e, !1);
      ...
      matchContext(m) {
        return G(this.parent, m);
      }
      enterUnfinishedNodesBefore(m) {
        let e = this.childBefore(m),
          t = this;
        for (; e; ) {
          let m = e.lastChild;
          if (!m || m.to != e.to) break;
          m.type.isError && m.from == m.to ? ((t = e), (e = m.prevSibling)) : (e = m);
        }
        return t;
      }
      get node() {
    ...
    class E extends V {
      constructor(m, e, t, s) {
        (super(), (this._tree = m), (this.from = e), (this.index = t), (this._parent = s));
      }
      get type() {
      ...
      nextChild(m, e, t, s, r = 0) {
        var i;
        for (let n = this; ; ) {
          for (
            let { children: o, positions: a } = n._tree, l = e > 0 ? o.length : -1;
            m != l;
            m += e
          ) {
            let l = o[m],
            ...
            if (
              (r & Z.EnterBracketed &&
                l instanceof _ &&
                null === (null === (i = X.get(l)) || void 0 === i ? void 0 : i.overlay) &&
                (p >= t || p + l.length <= t)) ||
              N(s, t, p, p + l.length)
            )
              if (l instanceof q) {
                if (r & Z.ExcludeBuffers) continue;
                let i = l.findChild(0, l.buffer.length, e, t - p, s);
                if (i > -1) return new H(new B(n, l, m, p), null, i);
              } else if (r & Z.IncludeAnonymous || !l.type.isAnonymous || K(l)) {
                let i;
                if (!(r & Z.IgnoreMounts) && (i = X.get(l)) && !i.overlay)
                  return new E(i.tree, p, m, n);
                let o = new E(l, p, m, n);
                return r & Z.IncludeAnonymous || !o.type.isAnonymous
                  ? o
                  : o.nextChild(e < 0 ? l.children.length - 1 : 0, e, t, s, r);
              }
          }
          if (r & Z.IncludeAnonymous || !n.type.isAnonymous) return null;
          if (
            ((m = n.index >= 0 ? n.index + e : e < 0 ? -1 : n._parent._tree.children.length),
            (n = n._parent),
            !n)
          )
            return null;
      ...
      childAfter(m) {
        return this.nextChild(0, 1, m, 2);
      }
      childBefore(m) {
        return this.nextChild(this._tree.children.length - 1, -1, m, -2);
      }
      prop(m) {
        return this._tree.prop(m);
      }
      enter(m, e, t = 0) {
        let s;
        if (!(t & Z.IgnoreOverlays) && (s = X.get(this._tree)) && s.overlay) {
          let r = m - this.from,
            i = t & Z.EnterBracketed && s.bracketed;
          for (let { from: m, to: t } of s.overlay)
            if ((e > 0 || i ? m <= r : m < r) && (e < 0 || i ? t >= r : t > r))
              return new E(s.tree, s.overlay[0].from + this.from, -1, this);
        }
        return this.nextChild(0, 1, m, e, t);
      }
      nextSignificantParent() {
        let m = this;
        for (; m.type.isAnonymous && m._parent; ) m = m._parent;
        return m;
      }
      get parent() {
    ...
    function I(m, e, t, s) {
      let r = m.cursor(),
        i = [];
      if (!r.firstChild()) return i;
      if (null != t) for (let m = !1; !m; ) if (((m = r.type.is(t)), !r.nextSibling())) return i;
      for (;;) {
        if (null != s && r.type.is(s)) return i;
        if ((r.type.is(e) && i.push(r.node), !r.nextSibling())) return null == s ? i : [];
      }
    }
    function G(m, e, t = e.length - 1) {
      for (let s = m; t >= 0; s = s.parent) {
        if (!s) return !1;
        if (!s.type.isAnonymous) {
          if (e[t] && e[t] != s.name) return !1;
          t--;
        }
      }
      return !0;
    ...
    class B {
      constructor(m, e, t, s) {
        ((this.parent = m), (this.buffer = e), (this.index = t), (this.start = s));
      }
    }
    class H extends V {
      get name() {
      ...
      constructor(m, e, t) {
        (super(),
          ...
          (this._parent = e),
          (this.index = t),
          (this.type = m.buffer.set.types[m.buffer.buffer[t]]));
      }
      child(m, e, t) {
        let { buffer: s } = this.context,
          r = s.findChild(this.index + 4, s.buffer[this.index + 3], m, e - this.context.start, t);
        return r < 0 ? null : new H(this.context, this, r);
      }
      get firstChild() {
      ...
      childAfter(m) {
        return this.child(1, m, 2);
      }
      childBefore(m) {
        return this.child(-1, m, -2);
      }
      prop(m) {
        return this.type.prop(m);
      }
      enter(m, e, t = 0) {
        if (t & Z.ExcludeBuffers) return null;
        let { buffer: s } = this.context,
          r = s.findChild(
            this.index + 4,
            s.buffer[this.index + 3],
            e > 0 ? 1 : -1,
            m - this.context.start,
            e,
          );
        return r < 0 ? null : new H(this.context, this, r);
      }
      ...
      externalSibling(m) {
        return this._parent ? null : this.context.parent.nextChild(this.context.index + m, m, 0, 4);
      }
      get nextSibling() {
        let { buffer: m } = this.context,
          e = m.buffer[this.index + 3];
        return e < (this._parent ? m.buffer[this._parent.index + 3] : m.buffer.length)
          ? new H(this.context, this._parent, e)
      ...
      get prevSibling() {
        ...
        return this.index == e
          ? this.externalSibling(-1)
          : new H(this.context, this._parent, m.findChild(e, this.index, -1, 0, 4));
      }
      get tree() {
        return null;
      }
      toTree() {
        ...
        if (r > s) {
          let i = t.buffer[this.index + 1];
          (m.push(t.slice(s, r, i)), e.push(0));
        }
        return new _(this.type, m, e, this.to - this.from);
      }
      toString() {
    ...
    function M(m) {
      ...
      for (let s = 1; s < m.length; s++) {
        let r = m[s];
        (r.from > t.from || r.to < t.to) && ((t = r), (e = s));
      }
      let s = t instanceof E && t.index < 0 ? null : t.parent,
        r = m.slice();
      return (s ? (r[e] = s) : r.splice(e, 1), new L(r, t));
    }
    class L {
      constructor(m, e) {
        ((this.heads = m), (this.node = e));
      }
      get next() {
        return M(this.heads);
      }
    ...
    class F {
      ...
      constructor(m, e = 0) {
        if (
          ...
          (this.mode = e & ~Z.EnterBracketed),
          m instanceof E)
        )
          this.yieldNode(m);
        else {
          ((this._tree = m.context.parent), (this.buffer = m.context));
          for (let e = m._parent; e; e = e._parent) this.stack.unshift(e.index);
          ((this.bufferNode = m), this.yieldBuf(m.index));
        }
      }
      yieldNode(m) {
        return (
          !!m &&
          ((this._tree = m), (this.type = m.type), (this.from = m.from), (this.to = m.to), !0)
        );
      }
      yieldBuf(m, e) {
        this.index = m;
        let { start: t, buffer: s } = this.buffer;
        return (
          (this.type = e || s.set.types[s.buffer[m]]),
          (this.from = t + s.buffer[m + 1]),
          (this.to = t + s.buffer[m + 2]),
          !0
        );
      }
      yield(m) {
        return (
          !!m &&
          (m instanceof E
            ? ((this.buffer = null), this.yieldNode(m))
            : ((this.buffer = m.context), this.yieldBuf(m.index, m.type)))
        );
      }
      toString() {
      ...
      enterChild(m, e, t) {
        if (!this.buffer)
          return this.yield(
            this._tree.nextChild(
              m < 0 ? this._tree._tree.children.length - 1 : 0,
              m,
              e,
              t,
              this.mode,
        ...
        let { buffer: s } = this.buffer,
          r = s.findChild(this.index + 4, s.buffer[this.index + 3], m, e - this.buffer.start, t);
      ...
      childAfter(m) {
        return this.enterChild(1, m, 2);
      }
      childBefore(m) {
        return this.enterChild(-1, m, -2);
      }
      enter(m, e, t = this.mode) {
        return this.buffer
          ? !(t & Z.ExcludeBuffers) && this.enterChild(1, m, e)
          : this.yield(this._tree.enter(m, e, t));
      }
      parent() {
        if (!this.buffer)
          return this.yieldNode(
            this.mode & Z.IncludeAnonymous ? this._tree._parent : this._tree.parent,
          );
        if (this.stack.length) return this.yieldBuf(this.stack.pop());
        let m =
          this.mode & Z.IncludeAnonymous
            ? this.buffer.parent
            : this.buffer.parent.nextSignificantParent();
        return ((this.buffer = null), this.yieldNode(m));
      }
      sibling(m) {
        if (!this.buffer)
          return (
            ...
            this.yield(
              this._tree.index < 0
                ? null
                : this._tree._parent.nextChild(this._tree.index + m, m, 0, 4, this.mode),
            )
          );
        let { buffer: e } = this.buffer,
          t = this.stack.length - 1;
        if (m < 0) {
          let m = t < 0 ? 0 : this.stack[t] + 4;
          if (this.index != m) return this.yieldBuf(e.findChild(m, this.index, -1, 0, 4));
        } else {
          let m = e.buffer[this.index + 3];
          if (m < (t < 0 ? e.buffer.length : e.buffer[this.stack[t] + 3])) return this.yieldBuf(m);
        }
        return (
          t < 0 &&
          this.yield(this.buffer.parent.nextChild(this.buffer.index + m, m, 0, 4, this.mode))
        );
      }
      nextSibling() {
      ...
      atLastNode(m) {
        ...
        if (s) {
          if (m > 0) {
            ...
            for (let m = 0; m < this.index; m++) if (s.buffer.buffer[m + 3] < this.index) return !1;
          ({ index: e, parent: t } = s);
        } else ({ index: e, _parent: t } = this._tree);
        for (; t; { index: e, _parent: t } = t)
          if (e > -1)
            for (let s = e + m, r = m < 0 ? -1 : t._tree.children.length; s != r; s += m) {
              let m = t._tree.children[s];
              if (this.mode & Z.IncludeAnonymous || m instanceof q || !m.type.isAnonymous || K(m))
                return !1;
            }
        return !0;
      }
      move(m, e) {
        if (e && this.enterChild(m, 0, 4)) return !0;
        for (;;) {
          if (this.sibling(m)) return !0;
          if (this.atLastNode(m) || !this.parent()) return !1;
        }
      }
      next(m = !0) {
        return this.move(1, m);
      }
      prev(m = !0) {
        return this.move(-1, m);
      }
      moveTo(m, e = 0) {
        for (
          ;
          (this.from == this.to ||
            (e < 1 ? this.from >= m : this.from > m) ||
            (e > -1 ? this.to <= m : this.to < m)) &&
          this.parent();

        );
        for (; this.enterChild(1, m, e); );
        return this;
      }
      get node() {
        if (!this.buffer) return this._tree;
        let m = this.bufferNode,
          e = null,
          t = 0;
        if (m && m.context == this.buffer)
          m: for (let s = this.index, r = this.stack.length; r >= 0; ) {
            for (let i = m; i; i = i._parent)
              if (i.index == s) {
                if (s == this.index) return i;
                ((e = i), (t = r + 1));
                break m;
              }
            s = this.stack[--r];
          }
        for (let m = t; m < this.stack.length; m++) e = new H(this.buffer, e, this.stack[m]);
        return (this.bufferNode = new H(this.buffer, e, this.index));
      }
      get tree() {
      ...
      iterate(m, e) {
        for (let t = 0; ; ) {
          let s = !1;
          if (this.type.isAnonymous || !1 !== m(this)) {
            if (this.firstChild()) {
              t++;
              continue;
            }
          ...
          for (;;) {
            if ((s && e && e(this), (s = this.type.isAnonymous), !t)) return;
      ...
      matchContext(m) {
        if (!this.buffer) return G(this.node.parent, m);
        let { buffer: e } = this.buffer,
          { types: t } = e.set;
        for (let s = m.length - 1, r = this.stack.length - 1; s >= 0; r--) {
          if (r < 0) return G(this._tree, m, s);
          let i = t[e.buffer[this.stack[r]]];
          if (!i.isAnonymous) {
            if (m[s] && m[s] != i.name) return !1;
            s--;
          }
        }
        return !0;
    ...
    function K(m) {
      return m.children.some((m) => m instanceof q || !m.type.isAnonymous || K(m));
    }
    const J = new WeakMap();
    function mm(m, e) {
      if (!m.isAnonymous || e instanceof q || e.type != m) return 1;
      let t = J.get(e);
      if (null == t) {
        t = 1;
        for (let s of e.children) {
          if (s.type != m || !(s instanceof _)) {
            t = 1;
            break;
          }
          t += mm(m, s);
    ...
    function em(m, e, t, s, r, i, n, o, a) {
      let l = 0;
      for (let t = s; t < r; t++) l += mm(m, e[t]);
      let p = Math.ceil((1.5 * l) / 8),
        O = [],
        h = [];
      return (
        (function e(t, s, r, n, o) {
          for (let l = r; l < n; ) {
            let r = l,
              u = s[l],
              c = mm(m, t[l]);
            ...
            if (l == r + 1) {
              if (c > p) {
                let m = t[r];
                e(m.children, m.positions, 0, m.children.length, s[r] + o);
                continue;
              }
              O.push(t[r]);
            } else {
              let e = s[l - 1] + t[l - 1].length - u;
              O.push(em(m, t, s, r, l, u, e, null, a));
            }
            h.push(u + o - i);
          }
        })(e, t, s, r, 0),
    ...
    class tm {
      startParse(m, e, t) {
        return (
          "string" == typeof m && (m = new sm(m)),
          (t = t
            ? t.length
              ? t.map((m) => new T(m.from, m.to))
              : [new T(0, 0)]
            : [new T(0, m.length)]),
          this.createParse(m, e || [], t)
        );
      }
      parse(m, e, t) {
        let s = this.startParse(m, e, t);
        for (;;) {
          let m = s.advance();
          if (m) return m;
        }
    ...
    class sm {
      ...
      chunk(m) {
        return this.string.slice(m);
      }
      get lineChunks() {
        return !1;
      }
      read(m, e) {
        return this.string.slice(m, e);
      }
    }
    new $({ perNode: !0 });
    class rm {
      constructor(m, e, t, s, r, i, n, o, a, l = 0, p) {
        ((this.p = m),
          (this.stack = e),
          (this.state = t),
          (this.reducePos = s),
      ...
      toString() {
        return `[${this.stack.filter((m, e) => e % 3 == 0).concat(this.state)}]@${this.pos}${this.score ? "!" + this.score : ""}`;
      }
      static start(m, e, t = 0) {
        let s = m.parser.context;
        return new rm(m, [], e, t, t, 0, [], 0, s ? new im(s, s.start) : null, 0, null);
      }
      get context() {
        return this.curContext ? this.curContext.context : null;
      }
      pushState(m, e) {
        (this.stack.push(this.state, e, this.bufferBase + this.buffer.length), (this.state = m));
      }
      reduce(m) {
        var e;
        let t = m >> 19,
          s = 65535 & m,
          { parser: r } = this.p,
          i = this.reducePos < this.pos - 25 && this.setLookAhead(this.pos),
          n = r.dynamicPrecedence(s);
        if ((n && (this.score += n), 0 == t))
          return (
            this.pushState(r.getGoto(this.state, s, !0), this.reducePos),
            s < r.minRepeatTerm && this.storeNode(s, this.reducePos, this.reducePos, i ? 8 : 4, !0),
            void this.reduceContext(s, this.reducePos)
          );
        let o = this.stack.length - 3 * (t - 1) - (262144 & m ? 6 : 0),
          a = o ? this.stack[o - 2] : this.p.ranges[0].from,
          l = this.reducePos - a;
        l >= 2e3 &&
          !(null === (e = this.p.parser.nodeSet.types[s]) || void 0 === e
            ? void 0
            : e.isAnonymous) &&
          (a == this.p.lastBigReductionStart
            ...
            : this.p.lastBigReductionSize < l &&
              ...
              (this.p.lastBigReductionSize = l)));
        let p = o ? this.stack[o - 1] : 0,
          O = this.bufferBase + this.buffer.length - p;
        if (s < r.minRepeatTerm || 131072 & m) {
          let m = r.stateFlag(this.state, 1) ? this.pos : this.reducePos;
          this.storeNode(s, a, m, O + 4, !0);
        }
        if (262144 & m) this.state = this.stack[o];
        else {
      ...
      storeNode(m, e, t, s = 4, r = !1) {
        if (
          ...
          if (
            (0 == s && m.parent && ((s = m.bufferBase - m.parent.bufferBase), (m = m.parent)),
            s > 0 && 0 == m.buffer[s - 4] && m.buffer[s - 1] > -1)
          ) {
            if (e == t) return;
            if (m.buffer[s - 2] >= e) return void (m.buffer[s - 2] = t);
          }
        }
        if (r && this.pos != t) {
          let r = this.buffer.length;
          if (r > 0 && (0 != this.buffer[r - 4] || this.buffer[r - 1] < 0)) {
            let m = !1;
            for (let e = r; e > 0 && this.buffer[e - 2] > t; e -= 4)
              if (this.buffer[e - 1] >= 0) {
                m = !0;
                break;
              }
            if (m)
              for (; r > 0 && this.buffer[r - 2] > t; )
          ...
          ((this.buffer[r] = m),
            ...
            (this.buffer[r + 2] = t),
            (this.buffer[r + 3] = s));
        } else this.buffer.push(m, e, t, s);
      }
      shift(m, e, t, s) {
        if (131072 & m) this.pushState(65535 & m, this.pos);
        else if (262144 & m)
          ((this.pos = s),
            this.shiftContext(e, t),
            e <= this.p.parser.maxNode && this.buffer.push(e, t, s, 4));
        else {
          let r = m,
            { parser: i } = this.p;
          ((this.pos = s),
            !i.stateFlag(r, 1) && (s > t || e <= i.maxNode) && (this.reducePos = s),
            this.pushState(r, Math.min(t, this.reducePos)),
            this.shiftContext(e, t),
            e <= i.maxNode && this.buffer.push(e, t, s, 4));
        }
      }
      apply(m, e, t, s) {
        65536 & m ? this.reduce(m) : this.shift(m, e, t, s);
      }
      useNode(m, e) {
        let t = this.p.reused.length - 1;
        (t < 0 || this.p.reused[t] != m) && (this.p.reused.push(m), t++);
        let s = this.pos;
        ((this.reducePos = this.pos = s + m.length),
          this.pushState(e, s),
          this.buffer.push(t, s, this.reducePos, -1),
          this.curContext &&
            this.updateContext(
              this.curContext.tracker.reuse(
                ...
                m,
                this,
                this.p.stream.reset(this.pos - m.length),
              ),
            ));
      }
      split() {
        let m = this,
          e = m.buffer.length;
        for (; e > 0 && m.buffer[e - 2] > m.reducePos; ) e -= 4;
        let t = m.buffer.slice(e),
          s = m.bufferBase + e;
        for (; m && s == m.bufferBase; ) m = m.parent;
        return new rm(
          this.p,
          this.stack.slice(),
          this.state,
      ...
      recoverByDelete(m, e) {
        let t = m <= this.p.parser.maxNode;
        (t && this.storeNode(m, this.pos, e, 4),
          this.storeNode(0, this.pos, e, t ? 8 : 4),
          (this.pos = this.reducePos = e),
          (this.score -= 190));
      }
      canShift(m) {
        for (let e = new nm(this); ; ) {
          let t = this.p.parser.stateSlot(e.state, 4) || this.p.parser.hasAction(e.state, m);
          if (0 == t) return !1;
          if (!(65536 & t)) return !0;
          e.reduce(t);
        }
      ...
      recoverByInsert(m) {
        ...
        if (e.length > 8 || this.stack.length >= 120) {
          let t = [];
          for (let s, r = 0; r < e.length; r += 2)
            (s = e[r + 1]) != this.state && this.p.parser.hasAction(s, m) && t.push(e[r], s);
          if (this.stack.length < 120)
            for (let m = 0; t.length < 8 && m < e.length; m += 2) {
              let s = e[m + 1];
              t.some((m, e) => 1 & e && m == s) || t.push(e[m], s);
            }
          e = t;
        }
        let t = [];
        for (let m = 0; m < e.length && t.length < 4; m += 2) {
          let s = e[m + 1];
          if (s == this.state) continue;
          let r = this.split();
          (r.pushState(s, this.pos),
            r.storeNode(0, r.pos, r.pos, 4, !0),
            r.shiftContext(e[m], this.pos),
      ...
      forceReduce() {
        let { parser: m } = this.p,
          e = m.stateSlot(this.state, 5);
        if (!(65536 & e)) return !1;
        if (!m.validAction(this.state, e)) {
          let t = e >> 19,
            s = 65535 & e,
            r = this.stack.length - 3 * t;
          if (r < 0 || m.getGoto(this.stack[r], s, !1) < 0) {
            let m = this.findForcedReduction();
            if (null == m) return !1;
            e = m;
          }
      ...
      get deadEnd() {
        ...
        let { parser: m } = this.p;
        return 65535 == m.data[m.stateSlot(this.state, 1)] && !m.stateSlot(this.state, 4);
      }
      restart() {
        (this.storeNode(0, this.pos, this.pos, 4, !0),
      ...
      sameState(m) {
        if (this.state != m.state || this.stack.length != m.stack.length) return !1;
        for (let e = 0; e < this.stack.length; e += 3) if (this.stack[e] != m.stack[e]) return !1;
        return !0;
      }
      get parser() {
      ...
      dialectEnabled(m) {
        return this.p.parser.dialect.flags[m];
      }
      shiftContext(m, e) {
        this.curContext &&
          this.updateContext(
            this.curContext.tracker.shift(this.curContext.context, m, this, this.p.stream.reset(e)),
          );
      }
      reduceContext(m, e) {
        this.curContext &&
      ...
      emitContext() {
        let m = this.buffer.length - 1;
        (m < 0 || -3 != this.buffer[m]) &&
          this.buffer.push(this.curContext.hash, this.pos, this.pos, -3);
      }
      emitLookAhead() {
        let m = this.buffer.length - 1;
        (m < 0 || -4 != this.buffer[m]) && this.buffer.push(this.lookAhead, this.pos, this.pos, -4);
      }
      updateContext(m) {
        if (m != this.curContext.context) {
          let e = new im(this.curContext.tracker, m);
          (e.hash != this.curContext.hash && this.emitContext(), (this.curContext = e));
        }
      }
      setLookAhead(m) {
        return !(m <= this.lookAhead) && (this.emitLookAhead(), (this.lookAhead = m), !0);
      }
      close() {
    ...
    class im {
      constructor(m, e) {
        ((this.tracker = m), (this.context = e), (this.hash = m.strict ? m.hash(e) : 0));
      }
    }
    class nm {
      constructor(m) {
    ...
    class om {
      ...
      static create(m, e = m.bufferBase + m.buffer.length) {
        return new om(m, e, e - m.bufferBase);
      }
      maybeNext() {
        let m = this.stack.parent;
        null != m &&
          ((this.index = this.stack.bufferBase - m.bufferBase),
          (this.stack = m),
          (this.buffer = m.buffer));
      }
      get id() {
    ...
    function am(m, e = Uint16Array) {
      if ("string" != typeof m) return m;
      let t = null;
      for (let s = 0, r = 0; s < m.length; ) {
        let i = 0;
        for (;;) {
          let e = m.charCodeAt(s++),
            t = !1;
          if (126 == e) {
            i = 65535;
            break;
    ...
    class Om {
      ...
      clipPos(m) {
        if (m >= this.range.from && m < this.range.to) return m;
        for (let e of this.ranges) if (e.to > m) return Math.max(m, e.from);
        return this.end;
      }
      peek(m) {
        let e,
          t,
          s = this.chunkOff + m;
        if (s >= 0 && s < this.chunk.length) ((e = this.pos + m), (t = this.chunk.charCodeAt(s)));
        else {
          let s = this.resolveOffset(m, 1);
          if (null == s) return -1;
          if (((e = s), e >= this.chunk2Pos && e < this.chunk2Pos + this.chunk2.length))
            t = this.chunk2.charCodeAt(e - this.chunk2Pos);
          else {
            let m = this.rangeIndex,
              s = this.range;
            for (; s.to <= e; ) s = this.ranges[++m];
            ((this.chunk2 = this.input.chunk((this.chunk2Pos = e))),
              e + this.chunk2.length > s.to && (this.chunk2 = this.chunk2.slice(0, s.to - e)),
              (t = this.chunk2.charCodeAt(0)));
          }
        }
        return (e >= this.token.lookAhead && (this.token.lookAhead = e + 1), t);
      }
      acceptToken(m, e = 0) {
        let t = e ? this.resolveOffset(e, -1) : this.pos;
        if (null == t || t < this.token.start) throw new RangeError("Token end out of bounds");
        ((this.token.value = m), (this.token.end = t));
      }
      acceptTokenTo(m, e) {
        ((this.token.value = m), (this.token.end = e));
      }
      getChunk() {
        if (this.pos >= this.chunk2Pos && this.pos < this.chunk2Pos + this.chunk2.length) {
          let { chunk: m, chunkPos: e } = this;
          ...
          let m = this.input.chunk(this.pos),
            e = this.pos + m.length;
          ((this.chunk = e > this.range.to ? m.slice(0, this.range.to - this.pos) : m),
      ...
      advance(m = 1) {
        for (this.chunkOff += m; this.pos + m >= this.range.to; ) {
          if (this.rangeIndex == this.ranges.length - 1) return this.setDone();
          ((m -= this.range.to - this.pos),
      ...
      reset(m, e) {
        if (
          (e
            ? ((this.token = e), (e.start = m), (e.lookAhead = m + 1), (e.value = e.extended = -1))
            : (this.token = pm),
          this.pos != m)
        ) {
          if (((this.pos = m), m == this.end)) return (this.setDone(), this);
          for (; m < this.range.from; ) this.range = this.ranges[--this.rangeIndex];
          for (; m >= this.range.to; ) this.range = this.ranges[++this.rangeIndex];
          (m >= this.chunkPos && m < this.chunkPos + this.chunk.length
            ? (this.chunkOff = m - this.chunkPos)
      ...
      read(m, e) {
        if (m >= this.chunkPos && e <= this.chunkPos + this.chunk.length)
          return this.chunk.slice(m - this.chunkPos, e - this.chunkPos);
        if (m >= this.chunk2Pos && e <= this.chunk2Pos + this.chunk2.length)
          return this.chunk2.slice(m - this.chunk2Pos, e - this.chunk2Pos);
        if (m >= this.range.from && e <= this.range.to) return this.input.read(m, e);
        let t = "";
        for (let s of this.ranges) {
          if (s.from >= e) break;
          s.to > m && (t += this.input.read(Math.max(s.from, m), Math.min(s.to, e)));
        }
        return t;
      }
    }
    class hm {
      constructor(m, e) {
        ((this.data = m), (this.id = e));
      }
      token(m, e) {
        let { parser: t } = e.p;
        cm(this.data, m, e, this.id, t.data, t.tokenPrecTable);
      }
    }
    hm.prototype.contextual = hm.prototype.fallback = hm.prototype.extend = !1;
    class um {
      constructor(m, e, t) {
        ((this.precTable = e),
          (this.elseToken = t),
          (this.data = "string" == typeof m ? am(m) : m));
      }
      token(m, e) {
        let t = m.pos,
          s = 0;
        for (;;) {
          let t = m.next < 0,
            r = m.resolveOffset(1, 1);
          if ((cm(this.data, m, e, 0, this.data, this.precTable), m.token.value > -1)) break;
          if (null == this.elseToken) return;
          if ((t || s++, null == r)) break;
          m.reset(r, m.token);
        }
        s && (m.reset(t, m.token), m.acceptToken(this.elseToken, s));
      }
    }
    um.prototype.contextual = hm.prototype.fallback = hm.prototype.extend = !1;
    function cm(m, e, t, s, r, i) {
      let n = 0,
        o = 1 << s,
        { dialect: a } = t.p.parser;
      m: for (; 0 != (o & m[n]); ) {
        let t = m[n + 1];
        for (let s = n + 3; s < t; s += 2)
          if ((m[s + 1] & o) > 0) {
            let t = m[s];
            if (
              a.allows(t) &&
              (-1 == e.token.value || e.token.value == t || Sm(t, e.token.value, r, i))
            ) {
              e.acceptToken(t);
              break;
            }
        ...
        let s = e.next,
          l = 0,
          p = m[n + 2];
        if (!(e.next < 0 && p > l && 65535 == m[t + 3 * p - 3])) {
          for (; l < p; ) {
            let r = (l + p) >> 1,
              i = t + r + (r << 1),
              o = m[i],
    ...
    function fm(m, e, t) {
      for (let s, r = e; 65535 != (s = m[r]); r++) if (s == t) return r - e;
      return -1;
    }
    function Sm(m, e, t, s) {
      let r = fm(t, s, e);
      return r < 0 || fm(t, s, m) < r;
    }
    const dm = "undefined" != typeof process && process.env && /\bparse\b/.test(process.env.LOG);
    let vm = null;
    function xm(m, e, t) {
      let s = m.cursor(Z.IncludeAnonymous);
      for (s.moveTo(e); ; )
        if (!(t < 0 ? s.childBefore(e) : s.childAfter(e)))
          for (;;) {
            if ((t < 0 ? s.to < e : s.from > e) && !s.type.isError)
              return t < 0
                ? Math.max(0, Math.min(s.to - 1, e - 25))
                : Math.min(m.length, Math.max(s.from + 1, e + 25));
            if (t < 0 ? s.prevSibling() : s.nextSibling()) break;
            if (!s.parent()) return t < 0 ? 0 : m.length;
          }
    }
    class gm {
      constructor(m, e) {
      ...
      nextFragment() {
        let m = (this.fragment = this.i == this.fragments.length ? null : this.fragments[this.i++]);
        if (m) {
          for (
            this.safeFrom = m.openStart ? xm(m.tree, m.from + m.offset, 1) - m.offset : m.from,
              this.safeTo = m.openEnd ? xm(m.tree, m.to + m.offset, -1) - m.offset : m.to;
            this.trees.length;

          )
            (this.trees.pop(), this.start.pop(), this.index.pop());
          (this.trees.push(m.tree),
            this.start.push(-m.offset),
            this.index.push(0),
            (this.nextStart = this.safeFrom));
        } else this.nextStart = 1e9;
      }
      nodeAt(m) {
        if (m < this.nextStart) return null;
        for (; this.fragment && this.safeTo <= m; ) this.nextFragment();
        ...
        for (;;) {
          ...
          let t = this.trees[e],
            s = this.index[e];
          if (s == t.children.length) {
            (this.trees.pop(), this.start.pop(), this.index.pop());
            continue;
          }
          let r = t.children[s],
            i = this.start[e] + t.positions[s];
          if (i > m) return ((this.nextStart = i), null);
          if (r instanceof _) {
            if (i == m) {
              if (i < this.safeFrom) return null;
              let m = i + r.length;
              if (m <= this.safeTo) {
                let e = r.prop($.lookAhead);
                if (!e || m + e < this.fragment.to) return r;
              }
            }
            (this.index[e]++,
              i + r.length >= Math.max(this.safeFrom, m) &&
                (this.trees.push(r), this.start.push(i), this.index.push(0)));
          } else (this.index[e]++, (this.nextStart = i + r.length));
        }
      }
    }
    class Qm {
      constructor(m, e) {
        ((this.stream = e),
          ...
          (this.mainToken = null),
          (this.actions = []),
          (this.tokens = m.tokenizers.map((m) => new lm())));
      }
      getActions(m) {
        let e = 0,
          t = null,
          { parser: s } = m.p,
          { tokenizers: r } = s,
          i = s.stateSlot(m.state, 3),
          n = m.curContext ? m.curContext.hash : 0,
          o = 0;
        for (let s = 0; s < r.length; s++) {
          ...
          if (
            (!t || a.fallback) &&
            ((a.contextual || l.start != m.pos || l.mask != i || l.context != n) &&
              (this.updateCachedToken(l, a, m), (l.mask = i), (l.context = n)),
            l.lookAhead > l.end + 25 && (o = Math.max(l.lookAhead, o)),
            0 != l.value)
          ) {
            let s = e;
            if (
              (l.extended > -1 && (e = this.addActions(m, l.extended, l.end, e)),
              (e = this.addActions(m, l.value, l.end, e)),
              !a.extend && ((t = l), e > s))
            )
              break;
          }
        ...
        return (
          o && m.setLookAhead(o),
          t ||
            m.pos != this.stream.end ||
            ((t = new lm()),
            (t.value = m.p.parser.eofTerm),
            (t.start = t.end = m.pos),
            (e = this.addActions(m, t.value, t.end, e))),
          (this.mainToken = t),
          this.actions
        );
      }
      getMainToken(m) {
        ...
        return (
          (e.start = t),
          (e.end = Math.min(t + 1, s.stream.end)),
          (e.value = t == s.stream.end ? s.parser.eofTerm : 0),
          e
        );
      }
      updateCachedToken(m, e, t) {
        let s = this.stream.clipPos(t.pos);
        if ((e.token(this.stream.reset(s, m), t), m.value > -1)) {
          let { parser: e } = t.p;
          for (let s = 0; s < e.specialized.length; s++)
            if (e.specialized[s] == m.value) {
              let r = e.specializers[s](this.stream.read(m.start, m.end), t);
              if (r >= 0 && t.p.parser.dialect.allows(r >> 1)) {
                1 & r ? (m.extended = r >> 1) : (m.value = r >> 1);
                break;
              }
            }
        } else ((m.value = 0), (m.end = this.stream.clipPos(s + 1)));
      }
      putAction(m, e, t, s) {
        for (let e = 0; e < s; e += 3) if (this.actions[e] == m) return s;
        return ((this.actions[s++] = m), (this.actions[s++] = e), (this.actions[s++] = t), s);
      }
      addActions(m, e, t, s) {
        let { state: r } = m,
          { parser: i } = m.p,
          { data: n } = i;
        for (let m = 0; m < 2; m++)
          for (let o = i.stateSlot(r, m ? 2 : 1); ; o += 3) {
            if (65535 == n[o]) {
              if (1 != n[o + 1]) {
                0 == s && 2 == n[o + 1] && (s = this.putAction(km(n, o + 2), e, t, s));
                break;
              }
              o = km(n, o + 2);
            }
            n[o] == e && (s = this.putAction(km(n, o + 1), e, t, s));
          }
        return s;
      }
    }
    class wm {
      constructor(m, e, t, s) {
        ((this.parser = m),
          ...
          (this.stream = new Om(e, s)),
          (this.tokens = new Qm(m, this.stream)),
          (this.topTerm = m.top[1]));
        let { from: r } = s[0];
        ((this.stacks = [rm.start(this, m.top[0], r)]),
          (this.fragments =
            t.length && this.stream.end - r > 4 * m.bufferLength ? new gm(t, m.nodeSet) : null));
      }
      get parsedPos() {
      ...
      advance() {
        ...
        if (this.bigReductionCount > 300 && 1 == t.length) {
          ...
          for (
            ...
            m.forceReduce() &&
            m.stack.length &&
            m.stack[m.stack.length - 2] >= this.lastBigReductionStart;
        ...
        for (let i = 0; i < t.length; i++) {
          let n = t[i];
          for (;;) {
            if (((this.tokens.mainToken = null), n.pos > s)) r.push(n);
            else {
              if (this.advanceStack(n, r, t)) continue;
              {
                (m || ((m = []), (e = [])), m.push(n));
                let t = this.tokens.getMainToken(n);
                e.push(t.value, t.end);
              }
            }
            break;
          }
        ...
        if (!r.length) {
          let e =
            ...
            (function (m) {
              ...
              for (let t of m) {
                let m = t.p.stoppedAt;
                (t.pos == t.p.stream.end || (null != m && t.pos > m)) &&
          ...
          if (this.parser.strict) throw new SyntaxError("No parse at " + s);
          this.recovering || (this.recovering = 5);
        }
        if (this.recovering && m) {
          let t =
            null != this.stoppedAt && m[0].pos > this.stoppedAt ? m[0] : this.runRecovery(m, e, r);
          if (t) return this.stackToTree(t.forceAll());
        }
        if (this.recovering) {
          let m = 1 == this.recovering ? 1 : 3 * this.recovering;
          if (r.length > m) for (r.sort((m, e) => e.score - m.score); r.length > m; ) r.pop();
          r.some((m) => m.reducePos > s) && this.recovering--;
        } else if (r.length > 1) {
          m: for (let m = 0; m < r.length - 1; m++) {
            let e = r[m];
            for (let t = m + 1; t < r.length; t++) {
              let s = r[t];
          ...
          r.length > 12 && (r.sort((m, e) => e.score - m.score), r.splice(12, r.length - 12));
        }
        this.minStackPos = r[0].pos;
        for (let m = 1; m < r.length; m++)
          r[m].pos < this.minStackPos && (this.minStackPos = r[m].pos);
        return null;
      }
      stopAt(m) {
        if (null != this.stoppedAt && this.stoppedAt < m)
      ...
      advanceStack(m, e, t) {
        let s = m.pos,
          { parser: r } = this;
        dm && this.stackID(m);
        if (null != this.stoppedAt && s > this.stoppedAt) return m.forceReduce() ? m : null;
        if (this.fragments) {
          let e = m.curContext && m.curContext.tracker.strict,
            t = e ? m.curContext.hash : 0;
          for (let i = this.fragments.nodeAt(s); i; ) {
            let s =
              this.parser.nodeSet.types[i.type.id] == i.type ? r.getGoto(m.state, i.type.id) : -1;
            if (s > -1 && i.length && (!e || (i.prop($.contextHash) || 0) == t))
              return (m.useNode(i, s), !0);
            if (!(i instanceof _) || 0 == i.children.length || i.positions[0] > 0) break;
            let n = i.children[0];
            if (!(n instanceof _ && 0 == i.positions[0])) break;
            i = n;
          }
        }
        let i = r.stateSlot(m.state, 4);
        if (i > 0) return (m.reduce(i), !0);
        if (m.stack.length >= 8400) for (; m.stack.length > 6e3 && m.forceReduce(); );
        let n = this.tokens.getActions(m);
        for (let r = 0; r < n.length; ) {
          ...
          if ((p.apply(i, o, O ? O.start : p.pos, a), l)) return !0;
          p.pos > s ? e.push(p) : t.push(p);
        }
        return !1;
      }
      advanceFully(m, e) {
        let t = m.pos;
        for (;;) {
          if (!this.advanceStack(m, null, null)) return !1;
          if (m.pos > t) return (Rm(m, e), !0);
        }
      }
      runRecovery(m, e, t) {
        let s = null,
        ...
        for (let i = 0; i < m.length; i++) {
          ...
          if (n.deadEnd) {
            if (r) continue;
            if (((r = !0), n.restart(), this.advanceFully(n, t))) continue;
          }
          let p = n.split(),
            O = l;
          for (let m = 0; m < 10 && p.forceReduce(); m++) {
            if (this.advanceFully(p, t)) break;
            dm && (O = this.stackID(p) + " -> ");
          }
          for (let m of n.recoverByInsert(o)) this.advanceFully(m, t);
          this.stream.end > n.pos
            ? (a == n.pos && (a++, (o = 0)), n.recoverByDelete(o, a), Rm(n, t))
            : (!s || s.score < p.score) && (s = p);
        }
        return s;
      }
      stackToTree(m) {
        return (
          ...
          _.build({
            ...
            length: m.pos - this.ranges[0].from,
            minRepeatType: this.parser.minRepeatTerm,
          })
        );
      }
      stackID(m) {
        let e = (vm || (vm = new WeakMap())).get(m);
        return (e || vm.set(m, (e = String.fromCodePoint(this.nextStackID++))), e + m);
      }
    }
    function Rm(m, e) {
      for (let t = 0; t < e.length; t++) {
        let s = e[t];
        if (s.pos == m.pos && s.sameState(m)) return void (e[t].score < m.score && (e[t] = m));
      }
      e.push(m);
    }
    class zm {
      constructor(m, e, t) {
        ((this.source = m), (this.flags = e), (this.disabled = t));
      }
      allows(m) {
        return !this.disabled || 0 == this.disabled[m];
      }
    }
    class bm extends tm {
      constructor(m) {
        if ((super(), (this.wrappers = []), 14 != m.version))
          throw new RangeError(`Parser version (${m.version}) doesn't match runtime version (14)`);
        let e = m.nodeNames.split(" ");
        this.minRepeatTerm = e.length;
        for (let t = 0; t < m.repeatNodeCount; t++) e.push("");
        let t = Object.keys(m.topRules).map((e) => m.topRules[e][1]),
          s = [];
        for (let m = 0; m < e.length; m++) s.push([]);
        function r(m, e, t) {
          s[m].push([e, e.deserialize(String(t))]);
        }
        if (m.nodeProps)
          for (let e of m.nodeProps) {
            let m = e[0];
            "string" == typeof m && (m = $[m]);
        ...
        ((this.nodeSet = new C(
          e.map((e, r) =>
            Y.define({
              ...
              top: t.indexOf(r) > -1,
              error: 0 == r,
              skipped: m.skippedNodes && m.skippedNodes.indexOf(r) > -1,
            }),
          ),
        )),
          m.propSources && (this.nodeSet = this.nodeSet.extend(...m.propSources)),
          (this.strict = !1),
          (this.bufferLength = P));
        let i = am(m.tokenData);
        ((this.context = m.context),
          (this.specializerSpecs = m.specialized || []),
          (this.specialized = new Uint16Array(this.specializerSpecs.length)));
        for (let m = 0; m < this.specializerSpecs.length; m++)
          this.specialized[m] = this.specializerSpecs[m].term;
        ((this.specializers = this.specializerSpecs.map(Pm)),
          (this.states = am(m.states, Uint32Array)),
          (this.data = am(m.stateData)),
          (this.goto = am(m.goto)),
          (this.maxTerm = m.maxTerm),
          (this.tokenizers = m.tokenizers.map((m) => ("number" == typeof m ? new hm(i, m) : m))),
          (this.topRules = m.topRules),
          (this.dialects = m.dialects || {}),
          (this.dynamicPrecedences = m.dynamicPrecedences || null),
          (this.tokenPrecTable = m.tokenPrec),
          (this.termNames = m.termNames || null),
          (this.maxNode = this.nodeSet.types.length - 1),
          (this.dialect = this.parseDialect()),
          (this.top = this.topRules[Object.keys(this.topRules)[0]]));
      }
      createParse(m, e, t) {
        let s = new wm(this, m, e, t);
        for (let r of this.wrappers) s = r(s, m, e, t);
        return s;
      }
      getGoto(m, e, t = !1) {
        let s = this.goto;
        ...
        for (let r = s[e + 1]; ; ) {
          let e = s[r++],
            ...
            n = s[r++];
          if (i && t) return n;
          for (let t = r + (e >> 1); r < t; r++) if (s[r] == m) return n;
          if (i) return -1;
        }
      }
      hasAction(m, e) {
        let t = this.data;
        for (let s = 0; s < 2; s++)
          for (let r, i = this.stateSlot(m, s ? 2 : 1); ; i += 3) {
            if (65535 == (r = t[i])) {
              if (1 != t[i + 1]) {
                if (2 == t[i + 1]) return km(t, i + 2);
                break;
              }
              r = t[(i = km(t, i + 2))];
            }
            if (r == e || 0 == r) return km(t, i + 1);
          }
        return 0;
      }
      stateSlot(m, e) {
        return this.states[6 * m + e];
      }
      stateFlag(m, e) {
        return (this.stateSlot(m, 0) & e) > 0;
      }
      validAction(m, e) {
        return !!this.allActions(m, (m) => m == e || null);
      }
      allActions(m, e) {
        let t = this.stateSlot(m, 4),
          s = t ? e(t) : void 0;
        for (let t = this.stateSlot(m, 1); null == s; t += 3) {
          if (65535 == this.data[t]) {
            if (1 != this.data[t + 1]) break;
            t = km(this.data, t + 2);
          }
          s = e(km(this.data, t + 1));
        }
        return s;
      }
      nextStates(m) {
        let e = [];
        for (let t = this.stateSlot(m, 1); ; t += 3) {
          if (65535 == this.data[t]) {
            if (1 != this.data[t + 1]) break;
            t = km(this.data, t + 2);
          }
          if (!(1 & this.data[t + 2])) {
            let m = this.data[t + 1];
            e.some((e, t) => 1 & t && e == m) || e.push(this.data[t], m);
          }
        }
        return e;
      }
      configure(m) {
        let e = Object.assign(Object.create(bm.prototype), this);
        if ((m.props && (e.nodeSet = this.nodeSet.extend(...m.props)), m.top)) {
          let t = this.topRules[m.top];
          if (!t) throw new RangeError(`Invalid top rule name ${m.top}`);
          e.top = t;
        }
        return (
          m.tokenizers &&
            (e.tokenizers = this.tokenizers.map((e) => {
              let t = m.tokenizers.find((m) => m.from == e);
              return t ? t.to : e;
            })),
          m.specializers &&
            ((e.specializers = this.specializers.slice()),
            (e.specializerSpecs = this.specializerSpecs.map((t, s) => {
              let r = m.specializers.find((m) => m.from == t.external);
              if (!r) return t;
              let i = Object.assign(Object.assign({}, t), { external: r.to });
              return ((e.specializers[s] = Pm(i)), i);
            }))),
          m.contextTracker && (e.context = m.contextTracker),
          m.dialect && (e.dialect = this.parseDialect(m.dialect)),
          null != m.strict && (e.strict = m.strict),
          m.wrap && (e.wrappers = e.wrappers.concat(m.wrap)),
          null != m.bufferLength && (e.bufferLength = m.bufferLength),
          e
        );
      }
      hasWrappers() {
      ...
      getName(m) {
        return this.termNames
          ? this.termNames[m]
          : String((m <= this.maxNode && this.nodeSet.types[m].name) || m);
      }
      get eofTerm() {
      ...
      dynamicPrecedence(m) {
        ...
        return null == e ? 0 : e[m] || 0;
      }
      parseDialect(m) {
        let e = Object.keys(this.dialects),
          t = e.map(() => !1);
        if (m)
          for (let s of m.split(" ")) {
            let m = e.indexOf(s);
            m >= 0 && (t[m] = !0);
          }
        let s = null;
        for (let m = 0; m < e.length; m++)
          if (!t[m])
            for (let t, r = this.dialects[e[m]]; 65535 != (t = this.data[r++]); )
              (s || (s = new Uint8Array(this.maxTerm + 1)))[t] = 1;
        return new zm(m, t, s);
      }
    ...
    function Um(m) {
      for (var e = 1; e < arguments.length; e++) {
        ...
        ("function" == typeof Object.getOwnPropertySymbols &&
          (s = s.concat(
            Object.getOwnPropertySymbols(t).filter(function (m) {
    ...
    const Ym = ["resource", "span", "event", "instrumentation", "link"],
      Cm = [
        "duration",
        "kind",
        "name",
      ...
      try {
                ...
                if (
                  (function (m) {
                    ...
                    if (s.firstChild())
                      do {
                        const m = s.node;
                        m.type.id === Tm ? e++ : 19 === m.type.id && (t = !0);
                      } while (s.nextSibling());
                    return 2 === e && t;
                  })(m)
                ) {
                    ...
                    if (i.firstChild())
                      do {
                        ...
                        if (m.type.id === Tm) {
                          const s = _m(m, e);
                          jm(m) ? (t = s) : Zm(m) && (r = s);
                        } else 19 === m.type.id && (s = _m(m, e));
                      } while (i.nextSibling());
                    if (!t || !s || !r) return null;
                    const { scope: n, tag: o } = Am(t);
                    if (!o) return null;
                    const a = qm(r);
                    if (null === a) return null;
                    return { scope: n, tag: o, operator: s, value: a };
                  })(m, e);
                  r && (t.push(r), s.add(m.from));
                } else {
                  const r = (function (m, e) {
                    let t = null,
                      s = null,
                    ...
                    return { scope: l, tag: p, operator: o, value: O };
                  })(m, e);
                  r && (t.push(r), s.add(m.from));
                }
              if (0 === m.type.id) {
                ...
                if (r && 17 === r.type.id) {
                  const r = _m(m, e),
                    i = m.nextSibling;
                  if (i && i.type.id === Tm && !s.has(i.from)) {
                    const n = (function (m) {
                      const e = m.match(/^([^=!<>~]+)(>=|<=|!=|=~|!~|=|>|<)(.+)$/);
                      if (!e) return null;
                      const [, t, s, r] = e,
                        ...
                        n = qm(r.trim());
                      if (!i || !n) return null;
                      const { scope: o, tag: a } = Am(i);
                      if (!a) return null;
                      return { scope: o, tag: a, operator: s, value: n };
                    })(r + _m(i, e));
                    if (n) return (t.push(n), s.add(m.from), void s.add(i.from));
                  }
                }
              }
              const i = m.cursor();
        ...
        r.length > 1 &&
          s.push({
            ...
            message: `Query contains ${r.length} spansets. Only the first spanset was extracted because traces-drilldown supports a single spanset only.`,
            query: e,
          });
        const i = (function (m) {
          let e = !1;
        ...
        (i &&
          ...
          (function (m, e, t) {
            m.iterate({
              enter: (m) => {
                (["Gt", "Lt", "Anc", "Desc"].includes(m.type.name) &&
                  t.push({
                    type: "unsupported_structural_operator",
                    message: `Structural operator (${m.type.name.toLowerCase()}) detected. Span relationships will be ignored, only basic filters will be extracted.`,
                    query: e,
                  }),
                  "Pipe" === m.type.name &&
                    t.push({
                      ...
                      message:
                        "Pipeline aggregation detected. Only the filter part will be extracted, aggregation will be ignored.",
                      query: e,
                    }),
                  "UnionStructuralOp" === m.type.name &&
                    t.push({
                      type: "unsupported_union_operator",
                      message:
                        "Union operator detected. Complex span relationships will be ignored, only basic filters will be extracted.",
                      query: e,
                    }));
              },
            });
        ...
        const n = (function (m) {
          const e = new Map();
          for (const t of m) {
            const m = `${t.scope}:${t.tag}:${t.operator}`;
            if (e.has(m)) {
              const s = e.get(m);
              Array.isArray(s.value) ? s.value.push(t.value) : (s.value = [s.value, t.value]);
            } else e.set(m, Um({}, t));
          }
          return Array.from(e.values());
        })(t);
        return 0 === n.length && 0 === s.length ? null : { filters: n, errors: s };
      } catch (m) {
        return null;
      }
    }
    function jm(m) {
      ...
      return (
        (function m(t) {
          if (28 === t.type.id || 26 === t.type.id) return void (e = !0);
          const s = t.cursor();
          if (s.firstChild())
            do {
              m(s.node);
            } while (s.nextSibling() && !e);
        })(m),
        e
      );
    }
    function Zm(m) {
      ...
      return (
        (function m(t) {
          if (20 === t.type.id) return void (e = !0);
          const s = t.cursor();
          if (s.firstChild())
            do {
              m(s.node);
    ...
    function _m(m, e) {
      return e.slice(m.from, m.to);
    }
    function Am(m) {
      const e = m.startsWith(".") ? m.slice(1) : m;
      for (const m of Cm)
        if (e === m) {
          if (m.includes(":")) {
            const [e, t] = m.split(":");
            return { scope: e, tag: t };
          }
          return { scope: "intrinsic", tag: m };
        }
      const t = e.indexOf(".");
      if (t > 0) {
        const m = e.slice(0, t),
          s = e.slice(t + 1);
        if (Ym.includes(m)) return { scope: m, tag: s };
      }
      return { scope: "intrinsic", tag: e };
    }
    function qm(m) {
      if (!m) return null;
      if ((m.startsWith('"') && m.endsWith('"')) || (m.startsWith("'") && m.endsWith("'"))) {
        return m.slice(1, -1).replace(/\\"/g, '"').replace(/\\'/g, "'").replace(/\\\\/g, "\\");
      }
      return !m.includes("|") || m.startsWith('"') || m.startsWith("'")
        ? m
        : m
            .split("|")
            .map((m) => m.trim())
    ...
    const Nm = [
      {
        targets: w.PluginExtensionPoints.DashboardPanelMenu,
      ...
      {
        targets: w.PluginExtensionPoints.ExploreToolbarAction,
    ...
    function Dm(m) {
      var e, t, s;
      if (!m) return;
      const r = m.targets.find((m) => {
        var e;
        return "tempo" === (null === (e = m.datasource) || void 0 === e ? void 0 : e.type);
      });
      if (!r || !(null === (e = r.datasource) || void 0 === e ? void 0 : e.uid)) return;
      let i =
        null === (t = r.filters) || void 0 === t
          ? void 0
          : t.filter((m) => m.scope && m.tag && m.operator && m.value && m.value.length);
      const n = new URLSearchParams();
      if (
        (n.append(
          `var-${k.EY}`,
          (null === (s = r.datasource) || void 0 === s ? void 0 : s.uid) || "",
        ),
        (!i || 0 === i.length) && r.query)
      ) {
        const m = Wm(r.query);
        (m &&
          m.filters.length > 0 &&
          ((i = m.filters.filter(
            (m) => m.scope && m.tag && m.operator && m.value && m.value.length,
          )),
          m.errors.length > 0 &&
            (console.warn("TraceQL parsing warnings for query:", r.query),
            m.errors.forEach((m) => {
              console.warn(`- ${m.type}: ${m.message}`);
            }))),
          n.append("actionView", "traceList"));
      }
      if (m.timeRange) {
        const e = (0, w.toURLRange)(m.timeRange);
        (n.append("from", String(e.from)), n.append("to", String(e.to)));
      }
      if (!i || 0 === i.length) {
        return { path: `${Vm(n)}` };
      }
      const o = i.find((m) => "status" === m.tag);
      (o && n.append(`var-${k.PU}`, "error" === o.value ? "errors" : "rate"),
        n.append("var-primarySignal", "true"));
      ((m) =>
        m
          .filter((m) => "status" !== m.tag)
          .map(
            (m) =>
              `${m.scope}${(function (m) {
                return (function (m) {
                  return Em.some((e) => e.tag === m.tag && e.scope === m.scope);
                })(m)
                  ? ":"
                  : ".";
              })(m)}${m.tag}|${m.operator}|${m.value}`,
          ))(i).forEach((m) => n.append(`var-${k.Ao}`, m));
      return { path: `${Vm(n)}` };
    }
    function Vm(m) {
      return `${k.D5}${m ? `?${m.toString()}` : ""}`;
    }
    const Em = [
      "event:name",
      "event:timeSinceStart",
    ...
    const Im = (0, g.lazy)(() => S.e(535).then(S.bind(S, 43535))),
      Gm = (0, g.lazy)(() => S.e(202).then(S.bind(S, 90202))),
      Bm = new w.AppPlugin()
        .setRootPage(Im)
        .addConfigPage({ title: "Configuration", icon: "cog", body: Gm, id: "configuration" })
        .exposeComponent({
        ...
        .exposeComponent({
          ...
          component: function (m) {
            return Q().createElement(
              g.Suspense,
              { fallback: Q().createElement("div", null, "Loading...") },
              Q().createElement(b, m),
            );
          },
        });
    for (const m of Nm) Bm.addLink(m);
    return d;
  })());
