...
export default function MarketHeader({ market, className }: MarketHeaderProps) {
  ...
  return (
    <div
      className={cn(
        "inline-block rounded-2xl border border-neutral-700/60 bg-neutral-950/80 px-3 py-2 shadow-sm",
        className,
      )}
    >
      {/* fila compacta, sin título de símbolo */}
      <div className="flex flex-wrap items-center gap-2 text-xs leading-tight text-neutral-300">
        {/* Base */}
